if [ "$1" = "" ]; then
	...
	ruby build_translation_rules.rb /home/notroot/git/KTE/code/yamls_TW/translation_rule_"$1".yml
	# mysql -u root -pkub01d --database=kte_driver -e "delete from translated_fields"
	ruby build_translated_fields.rb /home/notroot/git/KTE/code/yamls_TW/translated_field_"$1".yml
fi
