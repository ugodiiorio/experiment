if [ "$1" = "" ]; then
	...
	ruby build_field_mapping.rb /home/notroot/git/KTE/code/yamls_TW/field_mapping_"$1".yml
	# mysql -u root -pkub01d --database=kte_driver -e "delete from insurance_profiles"
	ruby build_profile.rb /home/notroot/git/KTE/code/yamls_TW/profile_"$1".yml
fi 
