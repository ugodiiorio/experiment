...
'pol_policy_starting_date_str' => 'translate_field',
...
'veh_set_up_str' => 'make=infield[:veh_set_up_str];  regexpi_mod_array = make.split(" "); regexp_mod = "regexpi:([A-Za-z0-9])*(\\\\s)*(?=.*?\\\\b" + regexpi_mod_array[0].to_s + "+" ; index=0 ;for index in (1..regexpi_mod_array.length-1);regexp_mod = regexp_mod + "((?=.*?\\\\b" + regexpi_mod_array[index].to_s + "\\\\b))*" end; regexp_mod = regexp_mod + ").+";',
...
'pol_natural_events_str' => 'translate_field',
...
'pol_number_of_NI_NA_yrs_during_5_yrs_str' => 'translate_field',
