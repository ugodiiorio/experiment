...
module Provider1ZurichConnect
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'pol_residence_str' => 'profilefield[:pol_residence_str].gsub("SAN GIOVANNI IN PERSICETO","SAN GIOVANNI IN PERSICET").gsub("TREVISAGO","TERVISAGO").gsub("DOLCE","DOLCE\'").gsub("PORTO SANT ELPIDIO","PORTO SANT\'ELPIDIO").gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA")',
