module Provider1ZurichConnect
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'driv_citizenship_str' => 'state=profilefield[:driv_citizenship_str].gsub("CINA","REPUBBLICA CINESE").gsub("PERU","PERU\'").gsub("IUGOSLAVIA","JUGOSLAVIA").gsub("PAESI BASSI","OLANDA")',
