module Provider1ZurichConnect
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'driv_birth_state_str' => 'state=profilefield[:driv_birth_state_str].gsub("CINA","REPUBBLICA CINESE").gsub("PERU","PERU\'").gsub("IUGOSLAVIA","JUGOSLAVIA").gsub("PAESI BASSI","OLANDA")',
      'driv_citizenship_str' => 'state=profilefield[:driv_citizenship_str].gsub("SAN MARINO","REP. DI S. MARINO").gsub("CINA","REPUBBLICA CINESE").gsub("PERU","PERU\'").gsub("IUGOSLAVIA","JUGOSLAVIA").gsub("PAESI BASSI","OLANDA")',
      ...
      'own_owner_zip_code_str' => 'res=profilefield[:own_owner_zip_code_str].gsub("30173","30100").gsub("30175","30100").gsub("30174","30100").gsub("30172","30100").gsub("34151","34100").gsub("00118","00119")',
      ...
      'pol_driver_zip_code_str' => 'res=profilefield[:pol_driver_zip_code_str].gsub("30173","30100").gsub("30175","30100").gsub("30174","30100").gsub("30172","30100").gsub("34151","34100").gsub("00118","00119")',
      ...
      'pol_residence_str' => 'res=profilefield[:pol_residence_str].gsub("D A","D\'A").gsub("SANT A","SANT\'A").gsub("SULL A","SULL\'A").gsub("SOMMARIVA DEL BOSCO","SOMMARIVA BOSCO").gsub("CAERANO DI SAN MARCO","CAERANO SAN MARCO").gsub("VILLANOVA CAMPOSAMPIERO","VILLANOVA DI CAMPOSANPIE").gsub("PONZANO VENETO","PONZANO").gsub("SAN GIOVANNI IN PERSICETO","SAN GIOVANNI IN PERSICET").gsub("TREVISAGO","TERVISAGO").gsub("DOLCE","DOLCE\'").gsub("SANT ELPIDIO","SANT\'ELPIDIO").gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA").gsub("FOSSO","FOSSO\'").gsub("SANT ANNA","SANT\'ANNA").gsub("D EZZELINO","D\'EZZELINO").gsub("SEZZE SCALO","SEZZE STAZIONE").gsub("GUIDONIA MONTECELIO","GUIDONIA").gsub("TOSCOLANO MADERNO","TOSCOLANO").gsub("BELLARIA IGEA MARINA","BELLARIA").gsub("ROVERE VERONESE","ROVERE\' VERONESE").gsub("D ALME", "D\'ALME\'").gsub("DE PASSERI", "DE\' PASSERI").gsub("SAN NICOLO","SAN NICOLO\'").gsub("ABANO TERME","ABANO TERME BAGNI").gsub("D ARCANO","D\'ARCANO").gsub("CASTIGLIONE STIVIERE","CASTIGLIONE DELLE STIVIE").gsub("D ALBA","D\'ALBA").gsub("D ADDA","D\'ADDA").gsub("D ASTI","D\'ASTI").gsub("MUGGIO","MUGGIO\'").gsub("SANREMO","SAN REMO").gsub("CASTELNUOVO MAGRA","MOLICCIARA").gsub("SAN GIULIANO MILANESE","S.GIULIANO MILANESE").gsub("SANT ELENA","SANT\'ELENA").gsub("L AQUILA","L\'AQUILA").gsub("D ESI","D\'ESI").gsub("DELL EMILIA","DELL\'EMILIA").gsub(/^VAGLIA/i,"SAN PIERO A SIEVE").gsub("SCANZANO JONICO","SCANZANO").gsub("CITTA ","CITTA\' ").gsub("SCORZE","SCORZE\'").gsub("SULL ARNO","SULL\'ARNO").gsub("SANT ANGELO","SANT\'ANGELO").gsub("MANSUE","MANSUE\'").gsub("IESOLO","JESOLO").gsub("DUINO","").gsub("FARA IN SABINA","FARA SABINA").gsub("CASTELL ","CASTELL\'").gsub("MONTECATINI TERME","MONTECATINI TERME E TETTUCCIO").gsub("TERRA SOLE","TERME").gsub("S CASCIANO IN","SAN CASCIANO").gsub("MASERA","MASERA\'").gsub("MONASTIER DI TREVISO","MONASTIER").gsub("MONTE COMPATRI","MONTECOMPATRI")',
