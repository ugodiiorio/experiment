...
'pol_theft_fire_coverage_str' => 'translate_field',
...
'veh_model_str' => 'make=infield[:veh_model_str]; make= make.gsub(/[0-9]+ª(\\s)+s.*/i, ""); regexpi_mod_array = make.split("/"); regexpi_mod_array = regexpi_mod_array[0].split(" "); regexpi_mod_array = make.split(" "); regexp_mod = "regexpi:([A-Za-z0-9])*";regexpi_mod_array.each do |el|; regexp_mod = regexp_mod + "(" + el.to_s + ".*)+(\\\\s)*" end;regexp_mod = regexp_mod + "\\\\b";',
...
'driv_driving_license_yrs_str' => 'translate_field',
...
'pol_driver_accident_indemnity_limit_str' => 'translate_field',
...
'pol_driver_accident_coverage_str' => 'translate_field',
