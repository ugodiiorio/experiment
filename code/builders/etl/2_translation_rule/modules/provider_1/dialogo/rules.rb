...
#      'veh_set_up_str' => '"allestimento"',
      ...
      'own_owner_residence_str' =>  'res=profilefield[:own_owner_residence_str];res=res.gsub("VILLA D ALME","VILLA D\'ALME\'");res=res.gsub("PONTE SAN NICOLO","PONTE SAN NICOLO\'");res=res.gsub("DOLCE","DOLCE\'");res=res.gsub("FOSSO","FOSSO\'");res=res.gsub("ROMANO D EZZELINO","ROMANO D\'EZZELINO");res=res.gsub("SANT ANNA ARRESI","SANT\'ANNA ARRESI")',
      ...
      'driv_birth_place_str' => 'res=profilefield[:driv_birth_place_str];res=res.gsub("VILLA D ALME","VILLA D\'ALME\'");res=res.gsub("PONTE SAN NICOLO","PONTE SAN NICOLO\'");res=res.gsub("DOLCE","DOLCE\'");res=res.gsub("FOSSO","FOSSO\'");res=res.gsub("ROMANO D EZZELINO","ROMANO D\'EZZELINO");res=res.gsub("SANT ANNA ARRESI","SANT\'ANNA ARRESI")',
