...
#      'veh_set_up_str' => '"allestimento"',
      ...
      'own_owner_residence_str' =>  'res=profilefield[:own_owner_residence_str];res=res.gsub("DOLCE","DOLCE\'");res=res.gsub("FOSSO","FOSSO\'");res=res.gsub("ROMANO D EZZELINO","ROMANO D\'EZZELINO");res=res.gsub("SANT ANNA ARRESI","SANT\'ANNA ARRESI")',
      ...
      'pol_nr_of_paid_claims_3_yr_str' => 'x= profilefield[:pol_nr_of_paid_claims_this_yr_str]; y= profilefield[:pol_nr_of_paid_claims_1_yr_str]; z= profilefield[:pol_nr_of_paid_claims_2_yr_str]; t= profilefield[:pol_nr_of_paid_claims_3_yr_str];  z == "N/A" ? sin= x.to_i+y.to_i+z.to_i : (t == "N/A" ? sin= x.to_i+y.to_i : sin= x.to_i+y.to_i+z.to_i+t.to_i); sin == 3 ? x = "3 o più" : x = sin_to_s',
      ...
      'pol_residence_str' => 'res=profilefield[:own_owner_residence_str];res=res.gsub("DOLCE","DOLCE\'");res=res.gsub("FOSSO","FOSSO\'");res=res.gsub("ROMANO D EZZELINO","ROMANO D\'EZZELINO");res=res.gsub("SANT ANNA ARRESI","SANT\'ANNA ARRESI")',
      ...
      'driv_birth_place_str' => 'res=profilefield[:driv_birth_place_str];res=res.gsub("DOLCE","DOLCE\'");res=res.gsub("FOSSO","FOSSO\'");res=res.gsub("ROMANO D EZZELINO","ROMANO D\'EZZELINO");res=res.gsub("SANT ANNA ARRESI","SANT\'ANNA ARRESI")',
