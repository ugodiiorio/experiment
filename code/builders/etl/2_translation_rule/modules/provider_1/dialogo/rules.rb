...
#      'veh_set_up_str' => '"allestimento"',
      ...
      'own_owner_residence_str' =>  'res=profilefield[:own_owner_residence_str].gsub("D ALME","D\'ALME\'").gsub("SAN NICOLO","SAN NICOLO\'").gsub("DOLCE","DOLCE\'").gsub("FOSSO","FOSSO\'").gsub("D EZZELINO","D\'EZZELINO").gsub("SANT ANNA","SANT\'ANNA").gsub("D ARCANO","D\'ARCANO").gsub("D ASTI","D\'ASTI").gsub("D ADDA","D\'ADDA").gsub("BRISSAGO VALTRAVAGLIA","BRISSAGO-VALTRAVAGLIA").gsub("D ESI","D\'ESI")',
      ...
      'pol_residence_str' => 'res=profilefield[:pol_residence_str].gsub("D ALME","D\'ALME\'").gsub("SAN NICOLO","SAN NICOLO\'").gsub("DOLCE","DOLCE\'").gsub("FOSSO","FOSSO\'").gsub("D EZZELINO","D\'EZZELINO").gsub("SANT ANNA","SANT\'ANNA").gsub("D ARCANO","D\'ARCANO").gsub("D ASTI","D\'ASTI").gsub("D ADDA","D\'ADDA").gsub("BRISSAGO VALTRAVAGLIA","BRISSAGO-VALTRAVAGLIA").gsub("D ESI","D\'ESI")',
      ...
      'driv_birth_place_str' => 'res=profilefield[:driv_birth_place_str].gsub("D ALME","D\'ALME\'").gsub("SAN NICOLO","SAN NICOLO\'").gsub("DOLCE","DOLCE\'").gsub("FOSSO","FOSSO\'").gsub("D EZZELINO","D\'EZZELINO").gsub("SANT ANNA","SANT\'ANNA").gsub("D ARCANO","D\'ARCANO").gsub("D ASTI","D\'ASTI").gsub("D ADDA","D\'ADDA").gsub("BRISSAGO VALTRAVAGLIA","BRISSAGO-VALTRAVAGLIA").gsub("D ESI","D\'ESI")',
