...
#      'pol_residence_province_str' => 'translate_field',
      'pol_residence_str' => 'res=profilefield[:pol_residence_str].gsub("UGGIATE TREVANO","UGGIATE-TREVANO").gsub("TOSCOLANO MADERNO","TOSCOLANO-MADERNO").gsub("BELLARIA IGEA MARINA","BELLARIA-IGEA MARINA").gsub("ROVERE VERONESE","ROVERE\' VERONESE").gsub("SANT ANNA ARRESI","SANT\'ANNA ARRESI").gsub("ROMANO D EZZELINO","ROMANO D\'EZZELINO").gsub("VILLA D ALME", "VILLA D\'ALME").gsub("TORRE DE PASSERI", "TORRE DE\' PASSERI").gsub("S CASCIANO IN VAL DI PESA", "SAN CASCIANO IN VAL DI PESA").gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA").gsub("PORTO SANT ELPIDIO","PORTO SANT\'ELPIDIO").gsub("DOLCE","DOLCE\'").gsub("RIVE D ARCANO","RIVE D\'ARCANO").gsub("CHALLAND SAINT ANSELME","CHALLAND-SAINT-ANSELME").gsub("CASTIGLIONE STIVIERE","CASTIGLIONE DELLE STIVIERE").gsub("BRISSAGO VALTRAVAGLIA","BRISSAGO-VALTRAVAGLIA").gsub("MONFORTE D ALBA","MONFORTE D\'ALBA").gsub("ARZAGO D ADDA","ARZAGO D\'ADDA").gsub("MONTEGROSSO D ASTI","MONTEGROSSO D\'ASTI").gsub("COCQUIO TREVISAGO","COCQUIO-TREVISAGO");',
