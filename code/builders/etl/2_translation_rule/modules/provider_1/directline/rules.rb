...
#      'driv_driving_license_year_of_issue_str' => 'copy_field',
      'driv_driving_license_yrs_str' => 'x = (profilefield[:driv_driving_license_yrs_str].to_i - 18 ); if x == 0; y="SI_MENO_UN_ANNO"; elsif x == 1; y="SI_UN_ANNO"; elsif x  < 2; y="SI_DUE_ANNI"; elsif x  == 3; y="SI_TRE_ANNI"; else  y="SI_OLTRE_TRE" end;',
...
#      'pol_residence_province_str' => 'translate_field',
      'pol_residence_str' => 'res=profilefield[:pol_residence_str].gsub("D A","D\'A").gsub("SANT ","SANT\'").gsub("SULL ","SULL\'").gsub("CASTELL ","CASTELL\'").gsub("MASERA","MASERA\'").gsub("S CASCIANO","SAN CASCIANO").gsub("LAVENO ","LAVENO-").gsub("VILLANOVA CAMPOSAMPIERO","VILLANOVA DI CAMPOSAMPIERO").gsub("DUINO ","DUINO-").gsub("MONTECATINI TERME","MONTECATINI-TERME").gsub("CASTROCARO TERRA SOLE","CASTROCARO TERME TERRA SOLE").gsub("UGGIATE TREVANO","UGGIATE-TREVANO").gsub("TOSCOLANO MADERNO","TOSCOLANO-MADERNO").gsub("BELLARIA IGEA MARINA","BELLARIA-IGEA MARINA").gsub("ROVERE VERONESE","ROVERE\' VERONESE").gsub("SANT ANNA","SANT\'ANNA").gsub("D EZZELINO","D\'EZZELINO").gsub("D ALME", "D\'ALME").gsub("DE PASSERI", "DE\' PASSERI").gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA").gsub("SANT ELPIDIO","SANT\'ELPIDIO").gsub("DOLCE","DOLCE\'").gsub("D ARCANO","D\'ARCANO").gsub("CASTIGLIONE STIVIERE","CASTIGLIONE DELLE STIVIERE").gsub("BRISSAGO VALTRAVAGLIA","BRISSAGO-VALTRAVAGLIA").gsub("D ALBA","D\'ALBA").gsub("D ADDA","D\'ADDA").gsub("D ASTI","D\'ASTI").gsub("COCQUIO TREVISAGO","COCQUIO-TREVISAGO").gsub("SANT ELENA","SANT\'ELENA").gsub("L AQUILA","L\'AQUILA").gsub("D ESI","D\'ESI").gsub(" FABIASCO","-FABIASCO").gsub("DELL EMILIA","DELL\'EMILIA").gsub("SCORZE","SCORZE\'").gsub("MONSUE","MONSUE\'").gsub("CITTA","CITTA\'")',
