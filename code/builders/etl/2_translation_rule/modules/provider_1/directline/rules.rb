module Provider1Directline
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'pol_matriculation_date_day_str' => '(DateTime::now - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%d")',
      'pol_matriculation_date_month_str' => '(DateTime::now - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%m")',
      'pol_matriculation_date_str' => '(DateTime::now - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%m/%Y")',
      'pol_matriculation_date_year_num' => '(DateTime::now - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%Y")',
      ...
      'pol_act_of_vandalisme_web_id_str' => 'translate_field',
