...
#      'pol_residence_province_str' => 'translate_field',
      'pol_residence_str' => 'res=profilefield[:pol_residence_str];res=res.gsub("UGGIATE TREVANO","UGGIATE-TREVANO");res=res.gsub("TOSCOLANO MADERNO","TOSCOLANO-MADERNO");res=res.gsub("BELLARIA IGEA MARINA","BELLARIA-IGEA MARINA");res=res.gsub("ROVERE VERONESE","ROVERE\' VERONESE");res=res.gsub("SANT ANNA ARRESI","SANT\'ANNA ARRESI");res=res.gsub("ROMANO D EZZELINO","ROMANO D\'EZZELINO");res=res.gsub("VILLA D ALME", "VILLA D\'ALME");res=res.gsub("TORRE DE PASSERI", "TORRE DE\' PASSERI");res=res.gsub("S CASCIANO IN VAL DI PESA", "SAN CASCIANO IN VAL DI PESA");res=res.gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA");res=res.gsub("PORTO SANT ELPIDIO","PORTO SANT\'ELPIDIO");res=res.gsub("DOLCE","DOLCE\'");',
