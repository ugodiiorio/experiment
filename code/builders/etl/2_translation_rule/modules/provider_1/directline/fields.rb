module Provider1Directline
  ...
  def build_hash_sect_1()
    ...
    @target_values = {
      ...
      {'pol_bersani_str' => 'convivente'} => '//input[@name="/qol/application/beans/vo/VoBMAgevolata.intProvenienza" and @value="2"]',
      {'pol_bersani_str' => 'veicolo'} => '//input[@name="/qol/application/beans/vo/VoBMAgevolata.intProvenienza" and @value="1"]',
