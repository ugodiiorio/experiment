...
module Provider1Directline
  ...
  def build_hash_sect_1()
    ...
    @target_values = {
      ...
      {'pol_coming_from_BM_num' => '-1'} => 'Classe 01',
      {'pol_coming_from_BM_num' => '1'} => 'Classe 01',
      {'pol_coming_from_BM_num' => '2'} => 'Classe 02',
      {'pol_coming_from_BM_num' => '3'} => 'Classe 03',
      {'pol_coming_from_BM_num' => '4'} => 'Classe 04',
      {'pol_coming_from_BM_num' => '5'} => 'Classe 05',
      {'pol_coming_from_BM_num' => '6'} => 'Classe 06',
      {'pol_coming_from_BM_num' => '7'} => 'Classe 07',
      {'pol_coming_from_BM_num' => '8'} => 'Classe 08',
      {'pol_coming_from_BM_num' => '9'} => 'Classe 09',
      {'pol_coming_from_BM_num' => '10'} => 'Classe 10',
      {'pol_coming_from_BM_num' => '11'} => 'Classe 11',
      {'pol_coming_from_BM_num' => '12'} => 'Classe 12',
      {'pol_coming_from_BM_num' => '13'} => 'Classe 13',
      {'pol_coming_from_BM_num' => '14'} => 'Classe 14',
      {'pol_coming_from_BM_num' => '15'} => 'Classe 15',
      {'pol_coming_from_BM_num' => '16'} => 'Classe 16',
      {'pol_coming_from_BM_num' => '17'} => 'Classe 17',
      {'pol_coming_from_BM_num' => '18'} => 'Classe 18',
