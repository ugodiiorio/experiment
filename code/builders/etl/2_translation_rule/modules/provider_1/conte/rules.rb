module Provider1Conte
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'driv_driving_license_month_of_issue_str' => 'x= (DateTime::now - profilefield[:pol_birth_date_str].to_i.years + 18.years + 11.months).strftime("%-1m"); y="index=" + x',
      ...
      'pol_residence_str' => 'res=profilefield[:pol_residence_str]; res.gsub("VILLA D ALME", "VILLA D\'ALME"); res.gsub("TORRE DE PASSERI", "TORRE DE\' PASSERI"); res.gsub("S CASCIANO IN VAL DI PESA", "SAN CASCIANO IN VAL DI PESA"); res.gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA"); res.gsub("DOLCE","DOLCE\'");',
...
#      'pol_matriculation_date_day_str' => 'profilefield[:pol_matriculation_date_str] == 10 ? copy_field : (Chronic.parse(@rate_date) - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%d")',
      ...
      'driv_birth_place_str' => 'res=profilefield[:driv_birth_place_str]; res.gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA"); res.gsub("VILLA D ALME", "VILLA D\'ALME"); res.gsub("TORRE DE PASSERI", "TORRE DE\' PASSERI"); res.gsub("S CASCIANO IN VAL DI PESA", "SAN CASCIANO IN VAL DI PESA"); res.gsub("DOLCE","DOLCE\'");',
      ...
      'driv_driving_license_year_of_issue_str' => 'x= (DateTime::now - profilefield[:pol_birth_date_str].to_i.years + 18.years + 11.months).strftime("%Y")',
