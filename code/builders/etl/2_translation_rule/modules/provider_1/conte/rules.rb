...
module Provider1Conte
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'pol_first_claim_year_str' => 'Chronic.parse(profilefield[:pol_first_claim_year_str] + " years before now").strftime("%Y")',
      'pol_second_claim_month_str' => 'copy_field',
      'pol_second_claim_year_str'  => 'Chronic.parse(profilefield[:pol_second_claim_year_str] + " years before now").strftime("%Y")',
