module Provider1Conte
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'pol_residence_str' => 'res=profilefield[:pol_residence_str]; res.gsub("VILLA D ALME", "VILLA D\'ALME"); res.gsub("TORRE DE PASSERI", "TORRE DE\' PASSERI"); res.gsub("S CASCIANO IN VAL DI PESA", "SAN CASCIANO IN VAL DI PESA");',
      ...
      'driv_birth_place_str' => 'res=profilefield[:driv_birth_place_str]; res.gsub("VILLA D ALME", "VILLA D\'ALME"); res.gsub("TORRE DE PASSERI", "TORRE DE\' PASSERI"); res.gsub("S CASCIANO IN VAL DI PESA", "SAN CASCIANO IN VAL DI PESA");',
