module Provider1Conte
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'pol_residence_str' => 'res=profilefield[:pol_residence_str];res=res.gsub("FOSSO","FOSSO\'");res=res.gsub("ROMANO D EZZELINO","ROMANO D\'EZZELINO");res=res.gsub("VILLA D ALME","VILLA D\'ALME");res=res.gsub("TORRE DE PASSERI","TORRE DE\' PASSERI");res=res.gsub("S CASCIANO IN VAL DI PESA","SAN CASCIANO IN VAL DI PESA");res=res.gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA");res=res.gsub("PORTO SANT ELPIDIO","PORTO SANT\'ELPIDIO");res=res.gsub("DOLCE","DOLCE\'");res=res.gsub("ROVERE VERONESE","ROVERE\' VERONESE");',
      'own_owner_specification_str' => 'copy_field',
      'own_owner_residence_province_str' =>  'translate_field'   ,
      'own_owner_residence_str' => 'res=profilefield[:own_owner_residence_str];res=res.gsub("FOSSO","FOSSO\'");res=res.gsub("ROMANO D EZZELINO","ROMANO D\'EZZELINO");res=res.gsub("VILLA D ALME","VILLA D\'ALME");res=res.gsub("TORRE DE PASSERI","TORRE DE\' PASSERI");res=res.gsub("S CASCIANO IN VAL DI PESA","SAN CASCIANO IN VAL DI PESA");res=res.gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA");res=res.gsub("PORTO SANT ELPIDIO","PORTO SANT\'ELPIDIO");res=res.gsub("DOLCE","DOLCE\'");res=res.gsub("ROVERE VERONESE","ROVERE\' VERONESE");',
...
#      'pol_matriculation_date_day_str' => 'profilefield[:pol_matriculation_date_str] == 10 ? copy_field : (Chronic.parse(@rate_date) - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%d")',
      ...
      'driv_birth_place_str' => 'res=profilefield[:driv_birth_place_str];res=res.gsub("FOSSO","FOSSO\'");res=res.gsub("ROMANO D EZZELINO","ROMANO D\'EZZELINO");res=res.gsub("VILLA D ALME","VILLA D\'ALME");res=res.gsub("TORRE DE PASSERI","TORRE DE\' PASSERI");res=res.gsub("S CASCIANO IN VAL DI PESA","SAN CASCIANO IN VAL DI PESA");res=res.gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA");res=res.gsub("PORTO SANT ELPIDIO","PORTO SANT\'ELPIDIO");res=res.gsub("DOLCE","DOLCE\'");res=res.gsub("ROVERE VERONESE","ROVERE\' VERONESE");',
