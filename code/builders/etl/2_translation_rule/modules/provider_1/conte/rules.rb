module Provider1Conte
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'driv_driving_license_month_of_issue_str' => 'x= (Chronic.parse(@setup_date) - profilefield[:pol_birth_date_str].to_i.years + 18.years + 11.months).strftime("%-1m"); y="index=" + x',
      ...
      'driv_birth_place_str' => 'res=profilefield[:driv_birth_place_str].gsub("D A","D\'A").gsub("SULL ","SULL\'").gsub("SANT ","SANT\'").gsub("SOMMARIVA DEL BOSCO","SOMMARIVA BOSCO").gsub("CAERANO DI","CAERANO").gsub("FARA IN SABINA","FARA SABINA").gsub("MONTECATINI ","MONTECATINI-").gsub("MONTE COMPATRI","MONTECOMPATRI").gsub("MASERA","MASERA\'").gsub("MONASTIER DI TREVISO","MONASTIER").gsub("SEZZE SCALO","SEZZE").gsub("PIANORO VECCHIO","PIANORO").gsub("CASTELL ","CASTELL\'").gsub("SANTA MARIA DELLE MOLE","MONTECOMPATRI").gsub("TERRA SOLE","TERME E TERRA DEL SOLE").gsub("VILLANOVA CAMPOSAMPIERO","VILLANOVA DI CAMPOSAMPIERO").gsub("DUINO ","DUINO-").gsub("SAN NICOLO","SAN NICOLO\'").gsub("SULL ARNO","SULL\'ARNO").gsub("FOSSO","FOSSO\'").gsub("D ALBA","D\'ALBA").gsub("L AQUILA","L\'AQUILA").gsub("CITTA ","CITTA\' ").gsub("D EZZELINO","D\'EZZELINO").gsub("D\'ALME","D\'ALME\'").gsub("DE PASSERI","DE\' PASSERI").gsub("S CASCIANO","SAN CASCIANO").gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA").gsub("SANT ELPIDIO","SANT\'ELPIDIO").gsub("DOLCE","DOLCE\'").gsub("SANT ANNA","SANT\'ANNA").gsub("ROVERE VERONESE","ROVERE\' VERONESE").gsub("D ARCANO","D\'ARCANO").gsub("CASTIGLIONE STIVIERE","CASTIGLIONE DELLE STIVIERE").gsub("MUGGIO","MUGGIO\'").gsub("D ASTI","D\'ASTI").gsub("SANT ELENA","SANT\'ELENA").gsub("D ESI","D\'ESI").gsub("D ADDA","D\'ADDA").gsub("DELL EMILIA","DELL\'EMILIA").gsub("MANSUE","MANSUE\'").gsub("FORLI","FORLI\'").gsub("SANT ANGELO","SANT\'ANGELO").gsub(" DELLE MOLE","").gsub("CITTA ","CITTA\' ").gsub("SULL ARNO","SULL\'ARNO").gsub("IESOLO","JESOLO").gsub("SCANZANO JONICO","SCANZANO").gsub("SCORZE","SCORZE\'")',
      ...
      'own_owner_residence_str' => 'res=profilefield[:own_owner_residence_str].gsub("D A","D\'A").gsub("SULL ","SULL\'").gsub("SANT ","SANT\'").gsub("CAERANO DI","CAERANO").gsub("FARA IN SABINA","FARA SABINA").gsub("MASERA","MASERA\'").gsub("MONTECATINI ","MONTECATINI-").gsub("MONTE COMPATRI","MONTECOMPATRI").gsub("MONASTIER DI TREVISO","MONASTIER").gsub("SOMMARIVA DEL BOSCO","SOMMARIVA BOSCO").gsub("PIANORO VECCHIO","PIANORO").gsub("SEZZE SCALO","SEZZE").gsub("CASTELL ","CASTELL\'").gsub("SANTA MARIA DELLE MOLE","MONTECOMPATRI").gsub("TERRA SOLE","TERME E TERRA DEL SOLE").gsub("VILLANOVA CAMPOSAMPIERO","VILLANOVA DI CAMPOSAMPIERO").gsub("DUINO ","DUINO-").gsub("SAN NICOLO","SAN NICOLO\'").gsub("SULL ARNO","SULL\'ARNO").gsub("FOSSO","FOSSO\'").gsub("D ALBA","D\'ALBA").gsub("L AQUILA","L\'AQUILA").gsub("CITTA ","CITTA\' ").gsub("D EZZELINO","D\'EZZELINO").gsub("D\'ALME","D\'ALME\'").gsub("DE PASSERI","DE\' PASSERI").gsub("S CASCIANO","SAN CASCIANO").gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA").gsub("SANT ELPIDIO","SANT\'ELPIDIO").gsub("DOLCE","DOLCE\'").gsub("SANT ANNA","SANT\'ANNA").gsub("ROVERE VERONESE","ROVERE\' VERONESE").gsub("D ARCANO","D\'ARCANO").gsub("CASTIGLIONE STIVIERE","CASTIGLIONE DELLE STIVIERE").gsub("MUGGIO","MUGGIO\'").gsub("D ASTI","D\'ASTI").gsub("SANT ELENA","SANT\'ELENA").gsub("D ESI","D\'ESI").gsub("D ADDA","D\'ADDA").gsub("DELL EMILIA","DELL\'EMILIA").gsub("MANSUE","MANSUE\'").gsub("FORLI","FORLI\'").gsub("SANT ANGELO","SANT\'ANGELO").gsub(" DELLE MOLE","").gsub("CITTA ","CITTA\' ").gsub("SULL ARNO","SULL\'ARNO").gsub("IESOLO","JESOLO").gsub("SCANZANO JONICO","SCANZANO").gsub("SCORZE","SCORZE\'")',

      'driv_birth_state_str' => 'state=profilefield[:driv_birth_state_str].gsub("SAN MARINO","REPUBBLICA DI SAN MARINO").gsub("CINA","CINA REPUBBLICA POPOLARE").gsub("CECOSLOVACCHIA","REPUBBLICA CECA").gsub("PERU","PERU\'").gsub("IUGOSLAVIA","CROAZIA");',
      ...
      'driv_driving_license_year_of_issue_str' => 'x= (Chronic.parse(@setup_date) - profilefield[:pol_birth_date_str].to_i.years + 18.years + 11.months).strftime("%Y")',
      ...
      'own_owner_zip_code_str' => 'profilefield[:own_owner_zip_code_str].gsub("04010","04018").gsub("50037","50036").gsub("40060","40065")',
