...
module Provider1Conte
  def build_hash_sect_1()
    ...
    @target_values = {
      ...
      {'pol_free_drive_str' => 'si'} => 'page:radioGuidatori:2',
      {'pol_free_drive_str' => 'no'} => 'no',
      {'pol_exclusive_drive_str' => 'si'} => 'page:radioGuidatori:0',
      {'pol_exclusive_drive_str' => 'no'} => 'no',
      {'pol_defined_drive_str' => 'si'} => 'page:radioGuidatori:1',
      {'pol_defined_drive_str' => 'no'} => 'no',
