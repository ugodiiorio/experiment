...
module Provider1Genialloyd
  ...
  def build_hash_sect_1()
    ...
    @target_values = {
      ...
      {'veh_alarm_str' => 'immobilizer'} => '//input[@id="antifurto_auto" and @name="antifurto_auto" and @value="1"]',
      ...
      {'driv_driving_license_year_of_issue_month_str' => '01'} => 'Gennaio',
      {'driv_driving_license_year_of_issue_month_str' => '02'} => 'Febbraio',
      {'driv_driving_license_year_of_issue_month_str' => '03'} => 'Marzo',
      {'driv_driving_license_year_of_issue_month_str' => '04'} => 'Aprile',
      {'driv_driving_license_year_of_issue_month_str' => '05'} => 'Maggio',
      {'driv_driving_license_year_of_issue_month_str' => '06'} => 'Giugno',
      {'driv_driving_license_year_of_issue_month_str' => '07'} => 'Luglio',
      {'driv_driving_license_year_of_issue_month_str' => '08'} => 'Agosto',
      {'driv_driving_license_year_of_issue_month_str' => '09'} => 'Settembre',
      {'driv_driving_license_year_of_issue_month_str' => '10'} => 'Ottobre',
      {'driv_driving_license_year_of_issue_month_str' => '11'} => 'Novembre',
      {'driv_driving_license_year_of_issue_month_str' => '12'} => 'Dicembre',
      {'pol_instalment_str' => 'annuale'} => 'Frazionamento Annuale',
      {'pol_instalment_str' => 'semestrale'} => 'Frazionamento Semestrale',
      {'pol_leasing_str' => 'no'} => '//input[@id="vincoli_auto" and @name="vincoli_auto" and @value="2"]',
      {'pol_public_liability_indemnity_limit_str' => '3000000'} => 'Û 3.000.000,00 unico',
      {'pol_public_liability_indemnity_limit_str' => '25000000'} => 'Û 5.000.000,00 unico',
      {'pol_public_liability_indemnity_limit_str' => '18000000'} => 'Û 5.000.000,00 unico',
      {'pol_public_liability_indemnity_limit_str' => '12000000'} => 'Û 5.000.000,00 unico',
      {'pol_public_liability_indemnity_limit_str' => '6000000'} => 'Û 5.000.000,00 unico',
      {'veh_vehicle_shelter_str' => 'box privato'} => 'Garage',
      {'pol_driver_sex_str' => 'M'} => '//input[@id="sesso" and @name="sesso" and @value="1"]',
      {'pol_driver_sex_str' => 'F'} => '//input[@id="sesso" and @name="sesso" and @value="2"]',
      {'pol_owner_sex_str' => 'M'} => 'Maschio',
      {'pol_owner_sex_str' => 'F'} => 'Femmina',
      {'pol_owner_sex_str' => 'C'} => 'PersonaGiuridica',
      {'own_owner_specification_str' => 'M'} => '//input[@id="fisgiur" and @name="fisgiur" and @value="0"]',
      {'own_owner_specification_str' => 'F'} => '//input[@id="fisgiur" and @name="fisgiur" and @value="0"]',
      {'own_owner_specification_str' => 'C'} => '//input[@id="fisgiur" and @name="fisgiur" and @value="3"]',
      {'veh_habitual_vehicle_use_str' => 'tempo libero-casa lavoro'} => 'Casa-Lavoro'
