...
module Provider1Genertel
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'driv_birth_place_str' => 'res=profilefield[:driv_birth_place_str];res=res.gsub("CHIARAVALLE","CHIARAVALLE|CHIARAVALLE (AN)").gsub("CASTELNUOVO DEL GARDA","CASTELNUOVO|CASTELNUOVO (VR)").gsub("UGGIATE TREVANO","UGGIATE-TREVANO").gsub("TOSCOLANO MADERNO","TOSCOLANO-MADERNO").gsub("BELLARIA IGEA MARINA","BELLARIA-IGEA MARINA").gsub("ROVERE VERONESE","ROVERE\' VERONESE").gsub("FOSSO","FOSSO\'").gsub("SANT ANNA ARRESI","SANT\' ANNA ARRESI").gsub("ROMANO D EZZELINO","ROMANO D\'EZZELINO").gsub("SEZZE SCALO","SEZZE").gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA").gsub("VILLA D ALME", "VILLA D\'ALME").gsub("TORRE DE PASSERI", "TORRE DE\' PASSERI").gsub("PORTO SANT ELPIDIO","PORTO SANT\'ELPIDIO").gsub("S CASCIANO IN VAL DI PESA", "SAN CASCIANO IN VAL DI PESA").gsub("DOLCE","DOLCE\'").gsub("RIVE D ARCANO","RIVE D\'ARCANO").gsub("CHALLAND SAINT ANSELME","CHALLAND-SAINT-ANSELME").gsub("CASTIGLIONE STIVIERE","CASTIGLIONE DELLE STIVIERE").gsub("BRISSAGO VALTRAVAGLIA","BRISSAGO-VALTRAVAGLIA").gsub("MONFORTE D ALBA","MONFORTE D\'ALBA").gsub("ARZAGO D ADDA","ARZAGO D\'ADDA").gsub("MONTEGROSSO D ASTI","MONTEGROSSO D\'ASTI").gsub("COCQUIO TREVISAGO","COCQUIO-TREVISAGO").gsub("CESANA BRIANZA","CESANA");',
#      'driv_birth_place_str' => 'copy_field',
      ...
      'own_owner_residence_str' =>  'res=profilefield[:own_owner_residence_str].gsub("ROVERE VERONESE","ROVERE\' VERONESE").gsub("FOSSO","FOSSO\'").gsub("SANT ANNA ARRESI","SANT\' ANNA ARRESI").gsub("ROMANO D EZZELINO","ROMANO D\'EZZELINO").gsub("SEZZE SCALO","SEZZE").gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA").gsub("VILLA D ALME", "VILLA D\'ALME").gsub("TORRE DE PASSERI", "TORRE DE\' PASSERI").gsub("PORTO SANT ELPIDIO","PORTO SANT\'ELPIDIO").gsub("S CASCIANO IN VAL DI PESA", "SAN CASCIANO IN VAL DI PESA").gsub("DOLCE","DOLCE\'").gsub("RIVE D ARCANO","RIVE D\'ARCANO").gsub("CASTIGLIONE STIVIERE","CASTIGLIONE DELLE STIVIERE").gsub("MONFORTE D ALBA","MONFORTE D\'ALBA").gsub("ARZAGO D ADDA","ARZAGO D\'ADDA").gsub("MONTEGROSSO D ASTI","MONTEGROSSO D\'ASTI");',
      ...
      'pol_residence_str' => 'res=profilefield[:pol_residence_str].gsub("ROVERE VERONESE","ROVERE\' VERONESE").gsub("FOSSO","FOSSO\'").gsub("SANT ANNA ARRESI","SANT\' ANNA ARRESI").gsub("ROMANO D EZZELINO","ROMANO D\'EZZELINO").gsub("SEZZE SCALO","SEZZE").gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA").gsub("VILLA D ALME", "VILLA D\'ALME").gsub("TORRE DE PASSERI", "TORRE DE\' PASSERI").gsub("PORTO SANT ELPIDIO","PORTO SANT\'ELPIDIO").gsub("S CASCIANO IN VAL DI PESA", "SAN CASCIANO IN VAL DI PESA").gsub("DOLCE","DOLCE\'").gsub("RIVE D ARCANO","RIVE D\'ARCANO").gsub("CASTIGLIONE STIVIERE","CASTIGLIONE DELLE STIVIERE").gsub("MONFORTE D ALBA","MONFORTE D\'ALBA").gsub("ARZAGO D ADDA","ARZAGO D\'ADDA").gsub("MONTEGROSSO D ASTI","MONTEGROSSO D\'ASTI");',
