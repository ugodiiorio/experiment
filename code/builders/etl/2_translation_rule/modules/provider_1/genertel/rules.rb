...
module Provider1Genertel
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'driv_birth_place_str' => 'res=profilefield[:driv_birth_place_str]; res.gsub("VILLA D ALME", "VILLA D\'ALME"); res.gsub("TORRE DE PASSERI", "TORRE DE\' PASSERI"); res.gsub("PORTO SANT ELPIDIO","PORTO SANT\'ELPIDIO"); res.gsub("S CASCIANO IN VAL DI PESA", "SAN CASCIANO IN VAL DI PESA"); res.gsub("DOLCE","DOLCE\'");',
#      'driv_birth_place_str' => 'copy_field',
      ...
      'pol_residence_str' => 'res=profilefield[:pol_residence_str]; res.gsub("VILLA D ALME", "VILLA D\'ALME"); res.gsub("TORRE DE PASSERI", "TORRE DE\' PASSERI"); res.gsub("PORTO SANT ELPIDIO","PORTO SANT\'ELPIDIO"); res.gsub("S CASCIANO IN VAL DI PESA", "SAN CASCIANO IN VAL DI PESA"); res.gsub("DOLCE","DOLCE\'");',
