...
#      'driv_birth_place_str' => 'copy_field',
      ...
      'own_owner_residence_str' =>  'res=profilefield[:own_owner_residence_str].gsub("ROVERE VERONESE","ROVERE\' VERONESE").gsub("FOSSO","FOSSO\'").gsub("SANT ANNA","SANT\' ANNA").gsub("D EZZELINO","D\'EZZELINO").gsub("SEZZE SCALO","SEZZE").gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA").gsub("VILLA D ALME", "VILLA D\'ALME").gsub("DE PASSERI", "DE\' PASSERI").gsub("SANT ELPIDIO","SANT\'ELPIDIO").gsub("S CASCIANO", "SAN CASCIANO").gsub("DOLCE","DOLCE\'").gsub("D ARCANO","D\'ARCANO").gsub("CASTIGLIONE STIVIERE","CASTIGLIONE DELLE STIVIERE").gsub("D ALBA","D\'ALBA").gsub("D ADDA","D\'ADDA").gsub("D ASTI","D\'ASTI").gsub("SANT ELENA","SANT\'ELENA").gsub("L AQUILA","L\'AQUILA").gsub(" SAGITTARIA","").gsub("D ESI","D\'ESI").gsub(" FABIASCO","-FABIASCO").gsub("DELL EMILIA","DELL\'EMILIA")',
      ...
      'pol_residence_str' => 'res=profilefield[:pol_residence_str].gsub("ROVERE VERONESE","ROVERE\' VERONESE").gsub("FOSSO","FOSSO\'").gsub("SANT ANNA","SANT\' ANNA").gsub("D EZZELINO","D\'EZZELINO").gsub("SEZZE SCALO","SEZZE").gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA").gsub("VILLA D ALME", "VILLA D\'ALME").gsub("DE PASSERI", "DE\' PASSERI").gsub("SANT ELPIDIO","SANT\'ELPIDIO").gsub("S CASCIANO", "SAN CASCIANO").gsub("DOLCE","DOLCE\'").gsub("D ARCANO","D\'ARCANO").gsub("CASTIGLIONE STIVIERE","CASTIGLIONE DELLE STIVIERE").gsub("D ALBA","D\'ALBA").gsub("D ADDA","D\'ADDA").gsub("D ASTI","D\'ASTI").gsub("SANT ELENA","SANT\'ELENA").gsub("L AQUILA","L\'AQUILA").gsub(" SAGITTARIA","").gsub("D ESI","D\'ESI").gsub(" FABIASCO","-FABIASCO").gsub("DELL EMILIA","DELL\'EMILIA")',
