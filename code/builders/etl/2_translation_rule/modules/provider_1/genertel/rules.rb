...
#      'driv_birth_place_str' => 'copy_field',
      ...
      'own_owner_residence_str' =>  'res=profilefield[:own_owner_residence_str];res=res.gsub("FOSSO","FOSSO\'");res=res.gsub("SANT ANNA ARRESI","SANT\' ANNA ARRESI");res=res.gsub("ROMANO D EZZELINO","ROMANO D\'EZZELINO");res=res.gsub("SEZZE SCALO","SEZZE");res=res.gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA");res=res.gsub("VILLA D ALME", "VILLA D\'ALME"); res=res.gsub("TORRE DE PASSERI", "TORRE DE\' PASSERI"); res=res.gsub("PORTO SANT ELPIDIO","PORTO SANT\'ELPIDIO"); res=res.gsub("S CASCIANO IN VAL DI PESA", "SAN CASCIANO IN VAL DI PESA"); res=res.gsub("DOLCE","DOLCE\'");',
      ...
      'pol_residence_str' => 'res=profilefield[:pol_residence_str];res=res.gsub("FOSSO","FOSSO\'");res=res.gsub("SANT ANNA ARRESI","SANT\' ANNA ARRESI");res=res.gsub("ROMANO D EZZELINO","ROMANO D\'EZZELINO");res=res.gsub("SEZZE SCALO","SEZZE");res=res.gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA");res=res.gsub("VILLA D ALME", "VILLA D\'ALME"); res=res.gsub("TORRE DE PASSERI", "TORRE DE\' PASSERI"); res=res.gsub("PORTO SANT ELPIDIO","PORTO SANT\'ELPIDIO"); res=res.gsub("S CASCIANO IN VAL DI PESA", "SAN CASCIANO IN VAL DI PESA"); res=res.gsub("DOLCE","DOLCE\'");',
