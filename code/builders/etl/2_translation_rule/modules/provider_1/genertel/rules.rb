...
'driv_driving_license_yrs_str' => 'TRUE',
'driv_job_str' => 'job=infield[:driv_job_str]; jregexp_mod = "regexpi:([A-Za-z0-9])*";jregexpi_mod_array = job.split("/"); jregexpi_mod_array.each do |el| ; el.split("/"); el.each do |el2|; jregexp_mod = jregexp_mod + "(" + el2.to_s + ".*)*(\\\\s)*" end; end ; jregexp_mod = jregexp_mod + "\\\\b" ;',
...
'pol_bersani_ref_car_already_insured_with_company_str' => 'translate_field',
...
'pol_contingency_protection_str' => 'translate_field',
...
'pol_legal_assistance_str' => 'translate_field',
...
'pol_policy_starting_date_dt' => 'copy_field',
...
'pol_road_assistance_str' => 'translate_field',
'pol_road_assistance_type_str' => 'translate_field',
...
'veh_make_str' => 'make=infield[:veh_make_str];  regexpi_mod_array = make.split(" "); regexp_mod = "regexpi:([A-Za-z0-9])*";regexpi_mod_array.each do |el|; regexp_mod = regexp_mod + "(" + el.to_s + ".*)+(\\\\s)*" end;regexp_mod = regexp_mod + "\\\\b";',
'veh_model_str' => 'make=infield[:veh_model_str]; make= make.gsub(/ª s$/i, " s"); make= make.gsub(/ª/, " "); regexpi_mod_array = make.split(" "); regexp_mod = "regexpi:([A-Za-z0-9])*";regexpi_mod_array.each do |el|; regexp_mod = regexp_mod + "(" + el.to_s + ".*)+(\\\\s)*" end;regexp_mod = regexp_mod + "\\\\b";',
'veh_new_used_vehicle_str' => 'copy_field',
'veh_set_up_str' => 'make=infield[:veh_set_up_str]; make= make.gsub(/(\\s)+ie(\\s)+/i, " i.e. "); regexpi_mod_array = make.split(" "); regexp_mod = "regexpi:([A-Za-z0-9])*(\\\\s)*(?=.*?\\\\b" + regexpi_mod_array[0].to_s + "+" ; index=0 ;for index in (1..regexpi_mod_array.length-1);regexp_mod = regexp_mod + "((?=.*?\\\\b" + regexpi_mod_array[index].to_s + "\\\\b))*" end; regexp_mod = regexp_mod + ").+";',
...
'driv_driving_license_year_of_issue_dt' => 'copy_field',
...
'pol_nr_of_goods_claims_1_yr_str' => 'copy_field',
'pol_nr_of_goods_claims_2_yr_str' => 'copy_field',
'pol_nr_of_goods_claims_3_yr_str' => 'copy_field',
'pol_nr_of_goods_claims_4_yr_str' => 'copy_field',
'pol_nr_of_goods_claims_5_yr_str' => 'copy_field',
'pol_nr_of_goods_claims_this_yr_str' => 'copy_field',
...
'pol_nr_of_persons_claims_1_yr_str' => 'copy_field',
'pol_nr_of_persons_claims_2_yr_str' => 'copy_field',
'pol_nr_of_persons_claims_3_yr_str' => 'copy_field',
'pol_nr_of_persons_claims_4_yr_str' => 'copy_field',
'pol_nr_of_persons_claims_5_yr_str' => 'copy_field',
'pol_nr_of_persons_claims_this_yr_str' => 'copy_field',
'pol_nr_of_claims_with_resp_principale_1_str' => 'copy_field',
'pol_nr_of_claims_with_resp_principale_2_str' => 'copy_field',
'pol_nr_of_claims_with_resp_principale_3_str' => 'copy_field',
'pol_nr_of_claims_with_resp_principale_4_str' => 'copy_field',
'pol_nr_of_claims_with_resp_principale_5_str' => 'copy_field',
'pol_nr_of_claims_with_resp_principale_this_yr_str' => 'copy_field',
'pol_nr_of_claims_with_resp_paritaria_1_str' => 'copy_field',
'pol_nr_of_claims_with_resp_ paritaria_2_str' => 'copy_field',
'pol_nr_of_claims_with_resp_ paritaria_3_str' => 'copy_field',
'pol_nr_of_claims_with_resp_ paritaria_4_str' => 'copy_field',
'pol_nr_of_claims_with_resp_ paritaria_5_str' => 'copy_field',
'pol_nr_of_claims_with_resp_ paritaria_this_yr_str' => 'copy_field',
...
'veh_purchase_date_dt' => 'copy_field',
