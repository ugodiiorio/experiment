module Provider1Linear
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'own_owner_residence_str' =>  'res=profilefield[:own_owner_residence_str].gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA").gsub("SANT ANNA","SANT\'ANNA").gsub("D EZZELINO","D\'EZZELINO").gsub("TOSCOLANO MADERNO","TOSCOLANO-MADERNO").gsub("BELLARIA IGEA MARINA","BELLARIA-IGEA MARINA").gsub("ROVERE VERONESE","ROVERE\' VERONESE").gsub("VILLA D ALME", "VILLA D\'ALME\'").gsub("DE PASSERI", "DE\' PASSERI").gsub("SAN NICOLO","SAN NICOLO\'").gsub("CASTIGLIONE STIVIERE","CASTIGLIONE DELLE STIVIER").gsub("D ALBA","D\'ALBA").gsub("D ADDA","D\'ADDA").gsub("D ASTI","D\'ASTI").gsub("BRISSAGO VALTRAVAGLIA","BRISSAGO-VALTRAVAGLIA").gsub("SANT ELPIDIO","SANT\'ELPIDIO").gsub("D ARCANO","D\'ARCANO").gsub("COCQUIO TREVISAGO","COCQUIO-TREVISAGO").gsub("D ESI","D\'ESI").gsub("SANREMO","SAN REMO").gsub("L AQUILA","L\'AQUILA")',
