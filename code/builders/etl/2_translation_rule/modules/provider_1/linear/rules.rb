module Provider1Linear
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'own_owner_residence_str' =>  'res=profilefield[:own_owner_residence_str].gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA").gsub("SANT ANNA ARRESI","SANT\'ANNA ARRESI").gsub("ROMANO D EZZELINO","ROMANO D\'EZZELINO");res=res.gsub("TOSCOLANO MADERNO","TOSCOLANO-MADERNO");res=res.gsub("BELLARIA IGEA MARINA","BELLARIA-IGEA MARINA");res=res.gsub("ROVERE VERONESE","ROVERE\' VERONESE");res=res.gsub("VILLA D ALME", "VILLA D\'ALME\'");res=res.gsub("TORRE DE PASSERI", "TORRE DE\' PASSERI");res=res.gsub("PONTE SAN NICOLO","PONTE SAN NICOLO\'")',
