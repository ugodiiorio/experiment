module Provider1Linear
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'driv_citizenship_str' => 'profilefield[:driv_citizenship_str].gsub("GRAN BRETAGNA","REGNO UNITO").gsub("GERMANIA","GERMANIA REPU. FEDERALE")',
      ...
      'own_owner_residence_str' =>  'res=profilefield[:own_owner_residence_str].gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA").gsub("SANT ANNA ARRESI","SANT\'ANNA ARRESI").gsub("ROMANO D EZZELINO","ROMANO D\'EZZELINO").gsub("TOSCOLANO MADERNO","TOSCOLANO-MADERNO").gsub("BELLARIA IGEA MARINA","BELLARIA-IGEA MARINA").gsub("ROVERE VERONESE","ROVERE\' VERONESE").gsub("VILLA D ALME", "VILLA D\'ALME").gsub("TORRE DE PASSERI", "TORRE DE\' PASSERI").gsub("PONTE SAN NICOLO","PONTE SAN NICOLO\'").gsub("CASTIGLIONE STIVIERE","CASTIGLIONE DELLE STIVIER").gsub("MONFORTE D ALBA","MONFORTE D\'ALBA").gsub("ARZAGO D ADDA","ARZAGO D\'ADDA").gsub("MONTEGROSSO D ASTI","MONTEGROSSO D\'ASTI").gsub("BRISSAGO VALTRAVAGLIA","BRISSAGO-VALTRAVAGLIA").gsub("PORTO SANT ELPIDIO","PORTO SANT\'ELPIDIO").gsub("RIVE D ARCANO","RIVE D\'ARCANO").gsub("COCQUIO TREVISAGO","COCQUIO-TREVISAGO")',
