module Provider1Linear
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'pol_residence_str' => 'res=profilefield[:pol_residence_str].gsub("D A","D\'A").gsub("SANT A","SANT\'A").gsub("CASTELL A","CASTELL\'A").gsub("GAMBASSI TERME","GAMBASSITERME").gsub("CASTROCARO TERRA SOLE","CASTROCARO TERME E TERRA").gsub("MASERA","MASERA\'").gsub("VILLANOVA CAMPOSANPIERO","VILLANOVA DI CAMPOSANPIER").gsub("MONTECATINI TERME","MONTECATINI-TERME").gsub("IESOLO","JESOLO").gsub("MONTE COMPATRI","MONTECOMPATRI").gsub("SEZZE SCALO","SEZZE").gsub("S CASCIANO IN VAL DI PESA","SAN CASCIANO IN VAL DI PE").gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA").gsub("SANT ANNA","SANT\'ANNA").gsub("D EZZELINO","D\'EZZELINO").gsub("TOSCOLANO MADERNO","TOSCOLANO-MADERNO").gsub("BELLARIA IGEA MARINA","BELLARIA-IGEA MARINA").gsub("ROVERE VERONESE","ROVERE\' VERONESE").gsub("DE PASSERI", "DE\' PASSERI").gsub("SAN NICOLO","SAN NICOLO\'").gsub("CASTIGLIONE STIVIERE","CASTIGLIONE DELLE STIVIER").gsub("D ALBA","D\'ALBA").gsub("D ADDA","D\'ADDA").gsub("D ASTI","D\'ASTI").gsub("BRISSAGO VALTRAVAGLIA","BRISSAGO-VALTRAVAGLIA").gsub("SANT ELPIDIO","SANT\'ELPIDIO").gsub("D ARCANO","D\'ARCANO").gsub("COCQUIO TREVISAGO","COCQUIO-TREVISAGO").gsub("D ESI","D\'ESI").gsub("SANREMO","SAN REMO").gsub("L AQUILA","L\'AQUILA").gsub(" FABIASCO","-FABIASCO").gsub("DELL EMILIA","DELL\'EMILIA").gsub("SANT ELENA","SANT\'ELENA").gsub("CITTA ","CITTA\' ").gsub("SULL ARNO","SULL\'ARNO").gsub("IESOLO","JESOLO").gsub("SANT ANGELO","SANT\'ANGELO").gsub("SANTA MARIA DELLE MOLE","MARINO")',
