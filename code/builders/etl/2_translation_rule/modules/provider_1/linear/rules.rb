module Provider1Linear
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'driv_birth_state_str' => 'state=profilefield[:driv_birth_state_str].gsub("GRAN BRETAGNA","REGNO UNITO").gsub("GERMANIA","GERMANIA REPU. FEDERALE").gsub("CINA","CINESE REPUB. POPOLARE").gsub("PERU","PERU\'").gsub("IUGOSLAVIA","JUGOSLAVIA")',
      'driv_citizenship_str' => 'state=profilefield[:driv_citizenship_str].gsub("GRAN BRETAGNA","REGNO UNITO").gsub("GERMANIA","GERMANIA REPU. FEDERALE").gsub("CINA","CINESE REPUB. POPOLARE").gsub("PERU","PERU\'").gsub("IUGOSLAVIA","JUGOSLAVIA")',
      'driv_civil_status_str' => 'copy_field',
      'driv_driver_sex_str' => 'translate_field',
      'driv_driving_experience_str'=> 'copy_field',
      'driv_driving_license_month_of_issue_str' => 'x= (Chronic.parse(@setup_date)  - profilefield[:pol_birth_date_str].to_i.years + 18.years).strftime("%-1m"); y="index=" + x',
      'driv_driving_license_points_str' => 'copy_field',
      'driv_driving_license_type_str' => 'copy_field',
      'driv_driving_license_year_of_issue_str' => 'x= (Chronic.parse(@setup_date)  - profilefield[:pol_birth_date_str].to_i.years + 18.years).strftime("%Y")',
      ...
      'own_owner_residence_str' =>  'res=profilefield[:own_owner_residence_str].gsub("D A","D\'A").gsub("SULL A","SULL\'A").gsub("SANT A","SANT\'A").gsub("CASTELL A","CASTELL\'A").gsub("PIANORO VECCHIO","PIANORO").gsub("GAMBASSI TERME","GAMBASSITERME").gsub("CASTROCARO TERRA SOLE","CASTROCARO TERME E TERRA").gsub("MASERA","MASERA\'").gsub("VILLANOVA CAMPOSAMPIERO","VILLANOVA DI CAMPOSAMPIER").gsub("MONTECATINI TERME","MONTECATINI-TERME").gsub("MONTE COMPATRI","MONTECOMPATRI").gsub("SEZZE SCALO","SEZZE").gsub("S CASCIANO IN VAL DI PESA","SAN CASCIANO IN VAL DI PE").gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA").gsub("SANT ANNA","SANT\'ANNA").gsub("D EZZELINO","D\'EZZELINO").gsub("TOSCOLANO MADERNO","TOSCOLANO-MADERNO").gsub("BELLARIA IGEA MARINA","BELLARIA-IGEA MARINA").gsub("ROVERE VERONESE","ROVERE\' VERONESE").gsub("DE PASSERI", "DE\' PASSERI").gsub("SAN NICOLO","SAN NICOLO\'").gsub("CASTIGLIONE STIVIERE","CASTIGLIONE DELLE STIVIER").gsub("D ALBA","D\'ALBA").gsub("D ADDA","D\'ADDA").gsub("D ASTI","D\'ASTI").gsub("BRISSAGO VALTRAVAGLIA","BRISSAGO-VALTRAVAGLIA").gsub("SANT ELPIDIO","SANT\'ELPIDIO").gsub("D ARCANO","D\'ARCANO").gsub("COCQUIO TREVISAGO","COCQUIO-TREVISAGO").gsub("D ESI","D\'ESI").gsub("SANREMO","SAN REMO").gsub("L AQUILA","L\'AQUILA").gsub(" FABIASCO","-FABIASCO").gsub("DELL EMILIA","DELL\'EMILIA").gsub("SANT ELENA","SANT\'ELENA").gsub("CITTA ","CITTA\' ").gsub("SULL ARNO","SULL\'ARNO").gsub("SANT ANGELO","SANT\'ANGELO").gsub("SANTA MARIA DELLE MOLE","MARINO")',
      ...
      'pol_residence_str' => 'res=profilefield[:pol_residence_str].gsub("D A","D\'A").gsub("SULL A","SULL\'A").gsub("SANT A","SANT\'A").gsub("CASTELL A","CASTELL\'A").gsub("PIANORO VECCHIO","PIANORO").gsub("GAMBASSI TERME","GAMBASSITERME").gsub("CASTROCARO TERRA SOLE","CASTROCARO TERME E TERRA").gsub("MASERA","MASERA\'").gsub("VILLANOVA CAMPOSAMPIERO","VILLANOVA DI CAMPOSAMPIER").gsub("MONTECATINI TERME","MONTECATINI-TERME").gsub("MONTE COMPATRI","MONTECOMPATRI").gsub("SEZZE SCALO","SEZZE").gsub("S CASCIANO IN VAL DI PESA","SAN CASCIANO IN VAL DI PE").gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA").gsub("SANT ANNA","SANT\'ANNA").gsub("D EZZELINO","D\'EZZELINO").gsub("TOSCOLANO MADERNO","TOSCOLANO-MADERNO").gsub("BELLARIA IGEA MARINA","BELLARIA-IGEA MARINA").gsub("ROVERE VERONESE","ROVERE\' VERONESE").gsub("DE PASSERI", "DE\' PASSERI").gsub("SAN NICOLO","SAN NICOLO\'").gsub("CASTIGLIONE STIVIERE","CASTIGLIONE DELLE STIVIER").gsub("D ALBA","D\'ALBA").gsub("D ADDA","D\'ADDA").gsub("D ASTI","D\'ASTI").gsub("BRISSAGO VALTRAVAGLIA","BRISSAGO-VALTRAVAGLIA").gsub("SANT ELPIDIO","SANT\'ELPIDIO").gsub("D ARCANO","D\'ARCANO").gsub("COCQUIO TREVISAGO","COCQUIO-TREVISAGO").gsub("D ESI","D\'ESI").gsub("SANREMO","SAN REMO").gsub("L AQUILA","L\'AQUILA").gsub(" FABIASCO","-FABIASCO").gsub("DELL EMILIA","DELL\'EMILIA").gsub("SANT ELENA","SANT\'ELENA").gsub("CITTA ","CITTA\' ").gsub("SULL ARNO","SULL\'ARNO").gsub("SANT ANGELO","SANT\'ANGELO").gsub("SANTA MARIA DELLE MOLE","MARINO")',
