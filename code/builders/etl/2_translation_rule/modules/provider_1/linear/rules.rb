module Provider1Linear
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'driv_driving_license_month_of_issue_str' => 'x= (DateTime::now  - profilefield[:pol_birth_date_str].to_i.years + 18.years).strftime("%-1m"); y="index=" + x',
      'driv_driving_license_points_str' => 'copy_field',
      'driv_driving_license_type_str' => 'copy_field',
      'driv_driving_license_year_of_issue_str' => 'x= (DateTime::now  - profilefield[:pol_birth_date_str].to_i.years + 18.years).strftime("%Y")',
      ...
      'own_owner_residence_str' =>  'profilefield[:own_owner_residence_str].gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA")',
