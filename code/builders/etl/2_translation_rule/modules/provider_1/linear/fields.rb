...
module Provider1Linear
  def build_hash_sect_1()
    ...
    @target_values = {
      ...
      {'driv_driving_license_month_of_issue_str' => '04'} => 'Aprile',
      ...
      {'driv_driving_license_month_of_issue_str' => '01'} => 'Gennaio',
      {'driv_driving_license_month_of_issue_str' => '06'} => 'Giugno',
      {'pol_RCA_premium_id_str' => 'id elemento'} => 'imp_massimale_1',
