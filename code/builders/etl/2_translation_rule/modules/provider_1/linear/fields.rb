...
module Provider1Linear
  def build_hash_sect_1()
    ...
    @target_values = {
      ...
      {'own_owner_specification_str' => 'M'} => '//input[@name=fisgiur and @value="0"]',
      {'own_owner_specification_str' => 'F'} => '//input[@name=fisgiur and @value="0"]',
      {'own_owner_specification_str' => 'C'} => '//input[@name=fisgiur and @value="3"]',
      {'pol_driver_sex_str' => 'M'} => '//input[@name=sesso and @value="1"]',
      {'pol_driver_sex_str' => 'F'} => '//input[@name=sesso and @value="2"]',
      ...
      {'pol_premium_id_str' => 'TRUE'} => 'imp_massimale_1',
