module Provider2Dialogo
  ...
  def build_hash_sect_1()
    ...
    @target_values = {
      ...
      #      {'pol_public_liability_indemnity_limit_str' => '3,000,000'} => '€ 3.000.000,00 - € 3.000.000,00 - € 3.000.000,00',
      #       {'pol_public_liability_indemnity_limit_str' => '6,000,000'} => '€ 8.000.000,00 - € 8.000.000,00 - € 8.000.000,00',
      {'pol_BM_assigned_str' => '0'} => '1 da almeno un anno',
  ...
  def build_hash_sect_2()
    ...
    @target_values = {
      ...
      {'pol_BM_assigned_str' => '17'} => '17',
      {'pol_BM_assigned_str' => '18'} => '18',
      {'pol_car_already_insured_with_company_str'  => 'no'} => '//input[@name="contentSubView:contentForm:chooseMoto:contraentePolizza" and @value="N"]',
      {'pol_car_already_insured_with_company_str'  => 'si'} => '//input[@name="contentSubView:contentForm:chooseMoto:contraentePolizza" and @value="Y"]',
      {'pol_driver_is_owner_str' => 'no'} => '//input[@name="contentSubView:contentForm:ProprietarioConducente" and @value="N"]',
      {'pol_driver_is_owner_str' => 'si'} => '//input[@name="contentSubView:contentForm:ProprietarioConducente" and @value="Y"]',
      {'pol_driver_accident_coverage_web_id_str' => 'id elemento'} => 'contentSubView:quotationTabletForm:proposalTable:3:_id146',
      {'pol_how_do_you_know_the_company_str' => 'passaparola'} => 'Passaparola',
      {'pol_insurance_situation_str' => 'proveniente da altra compagnia'} => '//input[@name="contentSubView:contentForm:attualeSituazione" and @value="3"]',
      {'pol_insurance_situation_str' => '1a immatricolazione'} => '//input[@name="contentSubView:contentForm:attualeSituazione" and @value="1"]',
      {'pol_legal_assistance_web_id_str'  => 'id elemento'} => 'contentSubView:quotationTabletForm:proposalTable:2:_id146',
      {'pol_public_liability_exemption_str' => '0'} => 'Nessuna',
      {'pol_number_plate_type_str' => 'definitiva'} => '//input[@name="contentSubView:vehicleForm:chooseMoto:foreignRegistration" and @value="false"]',
      {'pol_subscriber_is_owner_str' => 'si'} => '//input[@name="contentSubView:contentForm:chooseMoto:contrIsOwn" and @value="Y"]',
      {'pol_public_liability_indemnity_limit_str' => '3,000,000'} => '€ 3.000.000,00 - € 3.000.000,00 - € 3.000.000,00',
      {'pol_public_liability_indemnity_limit_str' => '3,500,000'} => '€ 3.500.000,00 - € 3.500.000,00 - € 3.500.000,00',
      {'pol_public_liability_indemnity_limit_str' => '5,000,000'} => '€ 5.000.000,00 - € 5.000.000,00 - € 5.000.000,00',
      {'pol_public_liability_indemnity_limit_str' => '8,000,000'} => '€ 8.000.000,00 - € 8.000.000,00 - € 8.000.000,00',
      {'pol_public_liability_indemnity_limit_str' => '10,000,000'} => '€ 10.000.000,00 - € 10.000.000,00 - € 10.000.000,00',
      {'pol_RCA_premium_id_str' => 'id elemento'} => '//span[@title="Costo Annuale"]' , # '//html/body/div[@id="containerHome"]/div[@id="corpopagina"]/div[@id="contents"]/form[@id="contentSubView:quotationTabletForm"]/div[@id="contentSubView:quotationTabletForm:quotationContainer"]/table[@id="contentSubView:quotationTabletForm:proposalTable"]/tbody/tr[6]/td/table/tbody/tr/td[2]/div[@id="sbox_Costo Annuale"]/span',
      {'pol_road_assistance_web_id_str' => 'id elemento'} => 'contentSubView:quotationTabletForm:proposalTable:1:_id146',
      {'pol_theft_fire_coverage_web_id_str'  => 'id elemento'} => 'contentSubView:quotationTabletForm:proposalTable:4:_id146',
      {'veh_fuel_str' => 'benzina'} => 'Benzina',
      {'veh_passenger_transportation_str'  => 'si'} => '/html/body/div/div[3]/div/form/div/fieldset/div[2]/table/tbody/tr/td/label/input',
      {'veh_passenger_transportation_str'  => 'no'} => '/html/body/div/div[3]/div/form/div/fieldset/div[2]/table/tbody/tr/td[2]/label/input',
      {'veh_vehicle_shelter_str' => 'box privato'} => '//input[@name="contentSubView:vehicleForm:chooseMoto:garage" and @value="true"]',
      {'veh_vehicle_type_str' => 'motociclo'} => '//input[@name="contentSubView:contentForm:vehicleSec" and @value="10"]',
      {'veh_vehicle_use_str' => 'privato'} => '//input[@name="contentSubView:contentForm:vehicleUsage" and @value="01"]',
