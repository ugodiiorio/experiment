...
#      'pol_driver_zip_code_str' => 'cap = infield[:pol_driver_zip_code_str].strip; cap = cap.gsub("15100","15121"); cap = cap.gsub("47023","47521");cap = cap.gsub("44100","44121");cap = cap.gsub("41100","41121");cap = cap.gsub("43100","43121");cap = cap.gsub("61100","61121");cap = cap.gsub("29100","29121");cap = cap.gsub("48100","48121");cap = cap.gsub("42100","42121");cap = cap.gsub("47900","47921");cap = cap.gsub("38100","38121");cap = cap.gsub("71100","71121");cap = cap.gsub("47100","47121");cap = cap.gsub("74100","74121");',
      ...
      'pol_matriculation_date_month_str' =>'profilefield[:pol_matriculation_date_str].length == 10 ? x= profilefield[:pol_matriculation_date_str].slice(3,2) : (profilefield[:pol_matriculation_date_str].to_i == 0 ? (x = (Chronic.parse(@setup_date)).strftime("-1%m"); x=x.to_i - 1) : x="00"); y= "index=" + x.to_s;',
      ...
      'pol_residence_str' => 'profilefield[:pol_residence_str].gsub(/agliano/i, "AGLIANO TERME")',
  ...
  def build_hash_sect_2()
    ...
    @rule_values = {
      ...
      'pol_how_do_you_know_the_company_str' => 'translate_field',
      'pol_insurance_situation_str' => 'translate_field',
      'pol_matriculation_date_month_str' =>'profilefield[:pol_matriculation_date_str].length == 10 ? x= profilefield[:pol_matriculation_date_str].slice(3,2) : (profilefield[:pol_matriculation_date_str].to_i == 0 ? x = (Chronic.parse(@rate_date))-profilefield[:pol_matriculation_date_str].to_i.years.strftime("%-1m") : x="01"); x=x.to_i-1; y= "index=" + x.to_s;',
      'pol_matriculation_date_year_num' => 'profilefield[:pol_matriculation_date_str].length > 2 ? profilefield[:pol_matriculation_date_str].slice(6,4) : (Chronic.parse(@rate_date) - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%Y")',
      'pol_nr_of_yrs_insured_in_the_last_5_yrs_str' => 'translate_field',
      'pol_policy_starting_date_day_str' => 'copy_field',
      'pol_policy_starting_date_month_str' => 'copy_field',
