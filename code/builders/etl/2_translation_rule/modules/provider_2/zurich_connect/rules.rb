module Provider2ZurichConnect
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'pol_matriculation_date_month_str' =>'profilefield[:pol_matriculation_date_str].length == 10 ? x= profilefield[:pol_matriculation_date_str].slice(3,2) : (profilefield[:pol_matriculation_date_str].to_i == 0 ? (x = (Chronic.parse(@setup_date)).strftime("%m"); x=x.to_i - 1) : x="0"); y= "index=" + x.to_s;',
