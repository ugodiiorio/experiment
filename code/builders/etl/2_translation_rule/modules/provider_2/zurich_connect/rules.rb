module Provider2ZurichConnect
  ...
  def build_hash_sect_1()
    ...
    @rule_values = { 'pol_nr_of_paid_claims_3_yr_str'  => 'copy_field' ,
      ...
      'pol_matriculation_date_month_str' => 'profilefield[:pol_matriculation_date_str].length > 2 ? (profilefield[:pol_matriculation_date_str].length == 10 ? profilefield[:pol_matriculation_date_str].slice(3,7) : copy_field )  : (Chronic.parse(@rate_date) - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%m");  x = x.to_i - 1 ;y= "index=" + x.to_s',
