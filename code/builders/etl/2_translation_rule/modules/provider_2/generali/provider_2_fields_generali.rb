...
module Provider2FieldsGenerali
  def build_hash_sect_1()
    ...
    @target_values = {
      ...
      {'veh_alarm_str' => 'immobilizer'} => ' Nessuno o altro',
      {'pol_risk_certificate_str' => 'si'} => 'TIPO_DICH_ATTESTAZIONE',
      {'pol_bersani_str' => 'Convivente'} => 'Si - rilasciato da altra Compagnia',
      {'pol_bersani_str' => 'Veicolo   '} => 'Si - rilasciato da altra Compagnia',
      ...
      {'pol_instalment_str' => 'annuale'} => 'RB_POLIZZA_ANNUALE',
      {'pol_instalment_str' => 'semestrale'} => 'RB_POLIZZA_TMP',
      ...
      {'pol_nr_of_paid_claims_2_yr_str' => 'N/A'} => 'Non Assicurato',
      {'pol_nr_of_paid_claims_2_yr_str' => 'N/D'} => 'Non Disponibile',
      {'pol_nr_of_paid_claims_3_yr_str' => '0'} => '0',
      {'pol_nr_of_paid_claims_3_yr_str' => '1'} => '1',
      {'pol_nr_of_paid_claims_3_yr_str' => '2'} => '2',
      {'pol_nr_of_paid_claims_3_yr_str' => 'N/A'} => 'Non Assicurato',
      {'pol_nr_of_paid_claims_3_yr_str' => 'N/D'} => 'Non Disponibile',
      {'pol_nr_of_paid_claims_4_yr_str' => '0'} => '0',
      {'pol_nr_of_paid_claims_4_yr_str' => '1'} => '1',
      {'pol_nr_of_paid_claims_4_yr_str' => '2'} => '2',
      {'pol_nr_of_paid_claims_4_yr_str' => 'N/A'} => 'Non Assicurato',
      {'pol_nr_of_paid_claims_4_yr_str' => 'N/D'} => 'Non Disponibile',
      {'pol_nr_of_paid_claims_5_yr_str' => '0'} => '0',
      {'pol_nr_of_paid_claims_5_yr_str' => '1'} => '1',
      {'pol_nr_of_paid_claims_5_yr_str' => '2'} => '2',
      {'pol_nr_of_paid_claims_5_yr_str' => 'N/A'} => 'Non Assicurato',
      {'pol_nr_of_paid_claims_5_yr_str' => 'N/D'} => 'Non Disponibile',
      {'pol_nr_of_paid_claims_1_yr_str' => '0'} => '0',
      {'pol_nr_of_paid_claims_1_yr_str' => '1'} => '1',
      {'pol_nr_of_paid_claims_1_yr_str' => '2'} => '2',
      {'pol_nr_of_paid_claims_1_yr_str' => 'N/A'} => 'Non Assicurato',
      {'pol_nr_of_paid_claims_1_yr_str' => 'N/D'} => 'Non Disponibile',
      {'pol_driver_sex_str' => 'M'} => 'Maschio',
      {'pol_driver_sex_str' => 'F'} => 'Femmina',
      {'pol_insurance_situation_str' => 'veicolo gi\' assicurato con atr'} => 'Gia\' assicurato con Bonus/Malus',
      ...
      {'pol_premium_id_str' => 'TRUE'} => 'TOTALE_PI_CL_10'
    }
