module Provider2Generali
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'pol_residence_str' => 'profilefield[:pol_residence_str].gsub("à","A\'").gsub("è","E\'").gsub("ì","I\'").gsub("ò","O\'").gsub("ù","U\'")',
      ...
      'veh_gas_methane_supply_str' => '(profilefield[:veh_fuel_str] == "benzina") ? " Benzina (motore solo a benzina)" : " Diesel" ',
