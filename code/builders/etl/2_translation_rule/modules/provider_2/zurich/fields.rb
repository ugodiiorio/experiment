module Provider2Zurich
  ...
  def build_hash_sect_1()
    ...
    @target_values = {
      ...
      {'pol_public_liability_indemnity_limit_str' => '50,000,000'} => '50.000.000 EURO',
  ...
  def build_hash_sect_4()
    ...
    @target_values = {
      ...
      {'pol_privacy_1_str' => 'id elemento web1'} => '//*[@id="check1"]',
      {'pol_public_liability_exemption_str' => '130'} => '500 EURO',
      {'pol_public_liability_exemption_str' => '250'} => '500 EURO',
      {'pol_public_liability_exemption_str' => '500'} => '500 EURO',
      {'pol_public_liability_exemption_str' => '1000'} => '1.000 EURO',
      ...
      {'pol_public_liability_indemnity_limit_str' => '10000000'} => '10.000.000 EURO',
      {'pol_public_liability_indemnity_limit_str' => '15000000'} => '15.000.000 EURO',
      {'pol_public_liability_indemnity_limit_str' => '26000000'} => '26.000.000 EURO',
      {'pol_RCA_premium_id_str' => 'id elemento'} => '//html/body/div/div/div/form/table[2]/tbody/tr[5]/td[2]/strong',
      {'pol_type_of_contract_str' => 'nuova polizza'} => '//input[@id="COD_TMOV_N"]',
