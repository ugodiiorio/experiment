module Provider2Conte
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'pol_matriculation_date_month_str' =>'x = (profilefield[:pol_matriculation_date_str].length > 2 ? (profilefield[:pol_matriculation_date_str].length == 10 ? profilefield[:pol_matriculation_date_str].slice(3,2) : copy_field ):(if profilefield[:pol_matriculation_date_str].to_i == 0 ; x = (Chronic.parse(@setup_date)).strftime("%m"); else x= "01"; end )); y= "index=" + x',
      ...
      'pol_matriculation_date_year_num' => 'profilefield[:pol_matriculation_date_str].length > 2 ? (profilefield[:pol_matriculation_date_str].length == 10 ? profilefield[:pol_matriculation_date_str].slice(6,4) : copy_field ):(if profilefield[:pol_matriculation_date_str].to_i == 0 ; x = (Chronic.parse(@setup_date)).strftime("%Y");  else x= (Chronic.parse(@rate_date) - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%Y"); end )',
      ...
      'veh_purchase_date_year_num' => 'profilefield[:veh_purchase_date_str].length > 2 ? (profilefield[:veh_purchase_date_str].length == 10 ? profilefield[:veh_purchase_date_str].slice(6,4) : copy_field )  : (if profilefield[:veh_purchase_date_str].to_i == 0 ; x = (Chronic.parse(@setup_date)).strftime("%Y"); else x= (Chronic.parse(@rate_date) - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%Y"); end );',
