  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'pol_matriculation_date_day_str' => '"not used"',
       'pol_matriculation_date_month_str' =>'profilefield[:pol_matriculation_date_str].length > 2 ? (profilefield[:pol_matriculation_date_str].length == 10 ? (x= profilefield[:pol_matriculation_date_str].slice(3,2); y="index=" + x ) : copy_field ):(if profilefield[:pol_matriculation_date_str].to_i == 0 ; x = (Chronic.parse(@setup_date)).strftime("%m"); y= "index=" + x; else x= "index=01"; end )',
