module Provider2Conte
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      'driv_driving_license_yrs_str'  => 'x=(DateTime::now  - profilefield[:driv_driving_license_yrs_str].to_i.years); y= x.year-Date.strptime(profilefield[:pol_birth_date_str]).year' ,
