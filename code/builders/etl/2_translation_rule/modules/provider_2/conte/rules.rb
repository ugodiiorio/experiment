module Provider2Conte
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'driv_driving_license_month_of_issue_str' => 'x= (Chronic.parse(@rate_date) - profilefield[:pol_birth_date_str].to_i.years + 18.years + 11.months).strftime("%-1m"); y="index=" + x',
      ...
      'pol_matriculation_date_day_str' => '"not used"',
      'pol_matriculation_date_month_str' =>'x = (profilefield[:pol_matriculation_date_str].length > 2 ? (profilefield[:pol_matriculation_date_str].length == 10 ? profilefield[:pol_matriculation_date_str].slice(3,2) : copy_field ):(if profilefield[:pol_matriculation_date_str].to_i == 0 ; x = (DateTime::now).strftime("%m"); else x= "01"; end )); y= "index=" + x',
      ...
      'pol_matriculation_date_year_num' => 'profilefield[:pol_matriculation_date_str].length > 2 ? (profilefield[:pol_matriculation_date_str].length == 10 ? profilefield[:pol_matriculation_date_str].slice(6,4) : copy_field ):(if profilefield[:pol_matriculation_date_str].to_i == 0 ; x = (DateTime::now).strftime("%Y");  else x= (Chronic.parse(@rate_date) - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%Y"); end )',
      'veh_purchase_date_str' => 'profilefield[:veh_purchase_date_str] == 10 ? (profilefield[:pol_matriculation_date_str].length == 10 ? profilefield[:pol_matriculation_date_str].slice(3,7) : copy_field )  : (Chronic.parse(@rate_date) - profilefield[:veh_purchase_date_str].to_i.years).strftime("%d/%m/%Y")',
      'veh_purchase_date_year_num' => 'profilefield[:veh_purchase_date_str].length > 2 ? (profilefield[:veh_purchase_date_str].length == 10 ? profilefield[:veh_purchase_date_str].slice(6,4) : copy_field )  : (if profilefield[:veh_purchase_date_str].to_i == 0 ; x = (DateTime::now).strftime("%Y"); else x= (Chronic.parse(@rate_date) - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%Y"); end );',
      'veh_purchase_date_month_str' => 'profilefield[:veh_purchase_date_str] == 10 ? (profilefield[:pol_matriculation_date_str].length == 10 ? profilefield[:pol_matriculation_date_str].slice(3,7) : copy_field )  : (Chronic.parse(@rate_date) - profilefield[:veh_purchase_date_str].to_i.years).strftime("%m")',
      'veh_purchase_date_day_str' => 'profilefield[:veh_purchase_date_str] == 10 ? (profilefield[:pol_matriculation_date_str].length == 10 ? profilefield[:pol_matriculation_date_str].slice(3,7) : copy_field )  : (Chronic.parse(@rate_date) - profilefield[:veh_purchase_date_str].to_i.years).strftime("%d")',
      ...
      'veh_set_up_str' => 'make=profilefield[:veh_set_up_str];make= make.gsub(/à/,"a" );make= make.gsub(/ì/,"i" );make= make.gsub(/ù/,"u" );make= make.gsub(/°/,"a" );make= make.gsub(/\\./,"\\\\." );make= make.gsub(/\\(/,"\\\\(" );make= make.gsub(/\\)/,"\\\\)" );make= make.gsub(/(\\s)+ie(\\s)+/i, " i.e. ");make= make.gsub(/(0)+([0-9]\/[0-9][0-9][0-9][0-9])/i, "\\2");regexpi_mod_array = make.split(" ");regexp_mod = "regexpi:([A-Za-z0-9])*";regexpi_mod_array.each do |el|;regexp_mod = regexp_mod + "(" + el.to_s + ".*)+(\\\\s)*" end;regexp_mod = regexp_mod + "$|regexpi:([A-Za-z0-9])*";regexpi_mod_array = make.split(" ");regexpi_mod_array.each do |el|;el_array = el.scan(/\d+/);el_array.each do |num|;num = "(?=.*(" + num.to_s + ".*)+)(\\\\s)*";regexp_mod = regexp_mod + num;end;el_array = el.scan(/\D+/);el_array.each do |char|;(char =~ /jt.*/i || char =~ /td.*/i || char =~ /cd.*/i || char =~ /sw|station|wagon/i )?char2 = "(?=.*(" + char.to_s + ".*)+)(\\\\s)*" :char2 = "(?=.*(" + char.to_s + ".*)*)(\\\\s)*";regexp_mod = regexp_mod + char2;end;end;regexp_mod = regexp_mod + "";',
      ...
      'pol_residence_str' => 'res=profilefield[:pol_residence_str]; res.gsub("VILLA D ALME", "VILLA D\'ALME"); res.gsub("TORRE DE PASSERI", "TORRE DE\' PASSERI"); res.gsub("S CASCIANO IN VAL DI PESA", "SAN CASCIANO IN VAL DI PESA"); res.gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA");',
      ...
      'driv_birth_place_str' => 'res=profilefield[:driv_birth_place_str]; res.gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA"); res.gsub("VILLA D ALME", "VILLA D\'ALME"); res.gsub("TORRE DE PASSERI", "TORRE DE\' PASSERI"); res.gsub("S CASCIANO IN VAL DI PESA", "SAN CASCIANO IN VAL DI PESA");',
      ...
      'driv_driving_license_year_of_issue_str' => 'x= (Chronic.parse(@rate_date) - profilefield[:pol_birth_date_str].to_i.years + 18.years + 11.months).strftime("%Y")',
      ...
      'pol_driving_type_str' => 'profilefield[:pol_birth_date_str].to_i > 28 ? translate_field : "page:radioGuidatori:2"',
  ...
  def build_hash_sect_2()
    ...
    @rule_values = {
      ...
      'driv_driving_license_month_of_issue_str' => 'x= (DateTime::now - profilefield[:driv_driving_license_yrs_str].to_i.years).strftime("%m");y= "index=" + x',
      'driv_driving_license_year_of_issue_str'=> 'x= (DateTime::now - profilefield[:driv_driving_license_yrs_str].to_i.years).strftime("%Y")',
