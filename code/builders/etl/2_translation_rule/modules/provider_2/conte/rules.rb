module Provider2Conte
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'pol_matriculation_date_year_num' => 'profilefield[:pol_matriculation_date_str].length == 10 ? profilefield[:pol_matriculation_date_str].slice(6,4) : (Chronic.parse(@rate_date) - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%Y")',
      ...
      'veh_purchase_date_month_str' => 'profilefield[:veh_purchase_date_str].length == 10 ? x= profilefield[:veh_purchase_date_str].slice(3,2) : (profilefield[:veh_purchase_date_str].to_i == 0 ? x = (Chronic.parse(@setup_date)).strftime("%m") : x="01"); y= "index=" + x;',
      ...
      'veh_purchase_date_year_num' => 'profilefield[:veh_purchase_date_str].length == 10 ? profilefield[:veh_purchase_date_str].slice(6,4) : (Chronic.parse(@rate_date) - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%Y")',
  ...
  def build_hash_sect_2()
    ...
    @rule_values = {
      ...
      'own_owner_specification_str'  => 'copy_field',
      'own_owner_residence_province_str'  => 'copy_field',
      'own_owner_residence_str'  => 'res=profilefield[:own_owner_residence_str]; res=res.gsub("VILLA D ALME", "VILLA D\'ALME");  res=res.gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA"); res=res.gsub("REGGIO DI CALABRIA","REGGIO CALABRIA"); res=res.gsub("AGLIANO","AGLIANO TERME").gsub("DUINO ","DUINO-");',
      'own_owner_specification_str'  => 'copy_field',
      ...
      'pol_RCA_code_str' => 'copy_field',
      'pol_RCA_on_off_str' => 'copy_field',
      'pol_residence_str' => 'res=profilefield[:pol_residence_str]; res=res.gsub("VILLA D ALME", "VILLA D\'ALME"); res=res.gsub("REGGIO NELL\'EMILIA","REGGIO EMILIA"); res=res.gsub("REGGIO DI CALABRIA","REGGIO CALABRIA"); res=res.gsub("AGLIANO","AGLIANO TERME").gsub("DUINO ","DUINO-");',
      'pol_residence_province_str' => 'profilefield[:pol_residence_province_str].length > 2 ? copy_field : translate_field',
      'pol_road_assistance_web_id_str' =>  'translate_field',
      'pol_subscriber_is_driver_str' => 'translate_field',
      'pol_subscriber_is_owner_str' => 'profilefield[:own_owner_specification_str] == "C" ? "page:contraente_proprietario:1" : "page:contraente_proprietario:0"',
