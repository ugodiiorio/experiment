module Provider2Conte
  ...
  def build_hash_sect_1()
    ...
    @target_values = {
      ...
      {'driv_job_str' => 'impiegato'} => 'Impiegato Azienda',
      {'driv_job_str' => 'agente o rappresentante di commercio'} => 'Rappresentante commerciale',
      {'driv_job_str' => 'agricoltore'} => 'Agricoltore',
      {'driv_job_str' => 'altro'} => 'Altro',
      {'driv_job_str' => 'architetto'} => 'Architetto',
      {'driv_job_str' => 'artigiano'} => 'Artigiano generico',
      {'driv_job_str' => 'autista professionista'} => 'Autista generico',
      {'driv_job_str' => 'avvocato'} => 'Avvocato',
      {'driv_job_str' => 'casalinga'} => 'Casalinga',
      {'driv_job_str' => 'commerciante'} => 'Commerciante generico',
      ...
      {'driv_job_str' => 'giudice/magistrato'} => 'Giudice generico',
      ...
      {'driv_job_str' => 'medico'} => 'Medico generico',
      {'driv_job_str' => 'studente'} => 'Studente generico',
    
      {'driv_job_str' => 'autista professionista'} => 'Autista',
      {'driv_job_str' => 'avvocato'} => 'Avvocato',
      ...
      {'driv_driving_license_type_str' => 'A senza limiti'} => 'Patente Italiana A Senza Limiti',
      {'driv_driving_license_type_str' => 'B'} => 'B (auto)',
      {'veh_fuel_str' => 'benzina'} => 'Benzina',
      {'veh_fuel_str' => 'diesel'} => 'Diesel',
      {'veh_fuel_str' => 'gasolio'} => 'GPL',
      {'veh_fuel_str' => 'metano'} => 'Metano',
      {'veh_alarm_str' => 'nessuno'} => 'No antifurto',
      {'pol_bersani_str' => 'si'} => 'page:decreto_bersani:0',
      ...
      {'pol_cohabiting_children_str' => 'no'} => 'page:figli_minori:1',
      ...
      {'pol_public_liability_indemnity_limit_str' => '15,000,000'} => '15.000.000',
      {'pol_public_liability_indemnity_limit_str' => '10,000,000'} => '10.000.000',
      {'pol_public_liability_indemnity_limit_str' => '5,000,000'} => '5.000.000',
  ...
  def build_hash_sect_2()
    ...
    @target_values = {
      ...
      {'driv_driving_license_type_str' => 'A senza limiti'} => 'Patente Italiana A Senza Limiti',
      {'driv_driving_license_type_str' => 'B'} => 'B (auto)',
      {'driv_driving_experience_str' => 'si'} => '1000',
      {'veh_fuel_str' => 'benzina'} => 'Benzina',
      {'veh_fuel_str' => 'diesel'} => 'Diesel',
      {'veh_fuel_str' => 'gasolio'} => 'GPL',
      {'veh_fuel_str' => 'metano'} => 'Metano',
      ...
      {'pol_claims_total_number_str' => '0'} => 'page:sinistri_cc:1',
      {'pol_claims_total_number_str' => '1'} => 'page:sinistri_cc:0',
      {'pol_driver_accident_coverage_web_id_str' => 'id elemento'} => 'page:quota_info:2:garanziaChecked',
      {'pol_client_type_str' => 'persona giuridica'} => 'page:relazione_contraente_proprietario_passo1:1 = persona giuridica',
      {'pol_driving_license_suspension_str' => 'no'} => 'page:sospensione_patente_contraente:1',
      {'pol_driving_type_str' => 'libera'} => 'page:radioGuidatori:2',
      {'pol_drunkenness_fine_str' => 'no'} => 'page:multe_ebrezza_contraente:1',
      {'pol_how_do_you_know_the_company_str' => 'passaparola'} => 'Passaparola',
      {'pol_insurance_situation_str' => 'proveniente da altra compagnia'} => 'page:situazione_1:1',
      {'pol_insurance_situation_str' => '1a immatricolazione'} => 'page:situazione_1:0',
      {'pol_insurapublic_liability_indemnity_limitnce_situation_str' => '1a immatricolazione'} => 'page:situazione_1:0',
      ...
      {'pol_residence_province_str' => 'VI'} => 'VICENZA',
      {'pol_residence_province_str' => 'VT'} => 'VITERBO',
      {'pol_road_assistance_web_id_str' => 'id elemento'} => 'page:quota_info:4:garanziaChecked',
      {'pol_subscriber_is_driver_str' => 'si'} => 'page:conducente_principale:0',
      {'pol_subscriber_is_owner_str' => 'si'} => 'page:contraente_proprietario:0',
      {'pol_subscriber_is_owner_str' => 'no'} => 'page:contraente_proprietario:1',
      {'pol_theft_fire_coverage_web_id_str' => 'id elemento'} => 'page:quota_info:1:garanziaChecked',
      {'pol_vehicle_continuous_use_no_of_mths_str' => 'più di due anni'} => '>24',
      {'veh_alarm_str' => 'nessuno'} => 'No antifurto',
      ...
      {'veh_new_used_vehicle_str' => 'U'} => 'page:situazione_2:1',
      {'veh_vehicle_shelter_str' => 'box privato'} => 'Box',
      {'veh_vehicle_type_str' => 'motociclo'} => 'Motociclo (sopra i 50 cc.)',
    }
