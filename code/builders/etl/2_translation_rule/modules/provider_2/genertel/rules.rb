...
module Provider2Genertel
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
  'pol_nr_of_paid_claims_2_yr_str'  => 'x= profilefield[:pol_nr_of_paid_claims_this_yr_str]; y= profilefield[:pol_nr_of_paid_claims_1_yr_str]; z= profilefield[:pol_nr_of_paid_claims_2_yr_str]; sin= x.to_i+y.to_i+z.to_i;' ,
