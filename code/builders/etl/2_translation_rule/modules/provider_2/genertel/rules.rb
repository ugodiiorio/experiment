 ...
 'pol_first_claim_month_str' => 'copy_field',
  ...
  def build_hash_sect_2()
    ...
    @rule_values = {
      ...
      'pol_public_liability_exemption_str' =>  'copy_field',
      'pol_public_liability_indemnity_limit_str' => 'translate_field',
      'pol_matriculation_date_str' => 'european_date = \'%m\'; (Chronic.parse(@rate_date) - profilefield[:pol_matriculation_date_str].to_i.years)strftime(european_date).to_s' ,
      'pol_nr_of_paid_claims_3_yr_str' => 'a= profilefield[:pol_nr_of_paid_claims_this_yr_str].to_i; b= profilefield[:pol_nr_of_paid_claims_1_yr_str].to_i; c= profilefield[:pol_nr_of_paid_claims_2_yr_str].to_i;sin= a+b+c; if (sin == 0) "0" elsif (sin == 1) "1" elsif (sin == 2) "2" elsif (sin == 3) "3" elsif (sin > 3) "Più di 3" else "N.A."',
