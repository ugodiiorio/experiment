module Provider2Directline
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'pol_family_car_num'  => 'translate_field' ,
  ...
  def build_hash_sect_2()
    ...
    @rule_values = {
      ...
      'driv_driving_license_type_str'  => 'copy_field' ,
      'driv_driving_license_year_of_issue_str'  => 'copy_field' ,
      'driv_driving_license_yrs_str' => 'x = (profilefield[:driv_driving_license_yrs_str].to_i - 18).to_i; if x == 1; y="SI_UN_ANNO"; elsif x  < 4; y="SI_DUE_ANNI"; elsif x  == 4; y="SI_TRE_ANNI"; else  y="SI_OLTRE_TRE" end;',
      'driv_heir_str'  => 'copy_field' ,
      'driv_italian_residence_starting_yrs_num'  => 'copy_field' ,
      'driv_job_2_str'  => 'copy_field' ,
