...
#      'driv_driving_license_year_of_issue_str' => 'copy_field',
      'driv_driving_license_yrs_str' => 'x = profilefield[:driv_driving_license_yrs_str].to_i; if x == 0; y="SI_MENO_UN_ANNO"; elsif x == 1; y="SI_UN_ANNO"; elsif x  < 2; y="SI_DUE_ANNI"; elsif x  == 3; y="SI_TRE_ANNI"; else  y="SI_OLTRE_TRE" end;',
...
#      'own_owner_residence_str' =>  'copy_field',
      ...
      'pol_act_of_vandalism_web_id_str' => 'translate_field',
...
#      'pol_matriculation_date_month_str' => '(Chronic.parse(@setup_date) - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%m")',
      'pol_matriculation_date_month_str' => 'profilefield[:pol_matriculation_date_str].length > 2 ? (profilefield[:pol_matriculation_date_str].length == 10 ? profilefield[:pol_matriculation_date_str].slice(3,2) : copy_field )  :  x= "01"',
      ...
      'pol_matriculation_date_year_num' => 'profilefield[:pol_matriculation_date_str].length > 2 ? (profilefield[:pol_matriculation_date_str].length == 10 ? profilefield[:pol_matriculation_date_str].slice(6,4) : copy_field )  :  x= (Chronic.parse(@setup_date) - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%Y")',
...
#      'pol_nr_of_paid_claims_this_yr_str' => 'if ',
...
#      'pol_matriculation_date_year_num' => '(Chronic.parse(@setup_date) - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%Y")',
      ...
      'veh_purchase_date_year_num' => ' if profilefield[:pol_bersani_str] == "si"; Chronic.parse(@setup_date).strftime("%Y"); else; (profilefield[:veh_purchase_date_str].length > 2 ? ( profilefield[:veh_purchase_date_str].length == 10 ? profilefield[:veh_purchase_date_str].slice(3,7) : copy_field )  : (Chronic.parse(@rate_date) - profilefield[:veh_purchase_date_str].to_i.years).strftime("%Y") ); end;',
      'veh_radioactive_substances_transportation_str' => 'copy_field',
      'veh_rent_str' => 'copy_field',
      'veh_rent_with_driver_str' => 'copy_field',
      'veh_set_up_previous_vehicle_str' => 'copy_field',
