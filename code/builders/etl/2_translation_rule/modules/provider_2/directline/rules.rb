module Provider2Directline
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'pol_claims_total_number_str' => 'profilefield[:pol_claims_total_number_str].to_i > 0  ? "causatoSinistriUltimi5Anni_TRUE" : "causatoSinistriUltimi5Anni_FALSE";',
  ...
  def build_hash_sect_2()
    ...
    @rule_values = {
      ...
      'driv_driving_license_type_str'  => 'copy_field' ,
      'driv_driving_license_year_of_issue_str'  => 'copy_field' ,
      'driv_driving_license_yrs_str' => 'x = (profilefield[:driv_driving_license_yrs_str].to_i - 18).to_i; if x == 1; y="policyHolder_drivingLicencePossess_li_3"; elsif x  < 4; y="policyHolder_drivingLicencePossess_li_4"; elsif x  == 4; y="policyHolder_drivingLicencePossess_li_5"; else  y="policyHolder_drivingLicencePossess_li_6" end;',
      ...
      'pol_athmospheric_events_premium_id_str'  => 'copy_field' ,
      'pol_athmospheric_events_web_id_str'  => 'copy_field' ,
      'pol_bersani_policy_expiring_date_str' => 'Chronic.parse(@rate_date).strftime("%d/%m/%Y");',
      'pol_bersani_ref_vehicle_insured_with_company_str'  => 'translate_field' ,
      'pol_bersani_ref_vehicle_number_plate_str'  => 'copy_field' ,
      'pol_bersani_str'  => 'translate_field' ,
      ...
      'pol_nr_of_paid_claims_5_yr_str'  => 'copy_field' ,
      'pol_nr_of_paid_claims_this_yr_str'  => 'translate_field' ,
      'pol_nr_of_yrs_insured_in_the_last_5_yrs_str' => 'profilefield[:pol_nr_of_yrs_insured_in_the_last_5_yrs_str].to_i >= 5 ? "veicoloAssicuratoUltimi5Anni_TRUE" : "veicoloAssicuratoUltimi5Anni_FALSE";',
      #'pol_nr_of_yrs_insured_in_the_last_5_yrs_str' => 'profilefield[:pol_nr_of_yrs_insured_in_the_last_5_yrs_str].to_i == 5 ? "//input[@name=\"Assic5a\" and @value=\"T\"]" : "//input[@name=\"Assic5a\" and @value=\"F\"]";',
      'pol_nr_of_yrs_without_claims_str'  => 'copy_field' ,
      'pol_number_of_NI_NA_yrs_during_5_yrs_str'  => 'copy_field' ,
      'pol_number_plate_type_str'  => 'copy_field' ,
