module Provider2Directline
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'pol_matriculation_date_str' => 'profilefield[:pol_matriculation_date_str].length > 2 ? (profilefield[:pol_matriculation_date_str].length == 10 ? profilefield[:pol_matriculation_date_str].slice(3,7) : copy_field )  :  ( if profilefield[:pol_matriculation_date_str].to_i == 0 ; x = (Chronic.parse(@setup_date)).strftime("%m/%Y"); else x= "01/" + (Chronic.parse(@rate_date) - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%Y"); end );',
