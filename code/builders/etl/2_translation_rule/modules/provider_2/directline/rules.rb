module Provider2Directline
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'pol_bersani_policy_expiring_date_str'  => 'european_date= \'%d/%m/%y\'; Date.strptime(profilefield[:pol_bersani_expiring_date_str], european_date).to_s;' ,
