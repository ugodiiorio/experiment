module Provider2Directline
  ...
  def build_hash_sect_1()
    ...
    @target_values = {
      ...
      {'pol_BM_assigned_str' => '0'} => 'Classe 01',
      ...
      {'pol_public_liability_indemnity_limit_str' => '2.500.000/1.000.000'} => '2.500.000/1.000.000',
      {'pol_public_liability_indemnity_limit_str' => '2.500.000/ 500.000'} => '2.500.000/ 500.000',
      {'pol_public_liability_indemnity_limit_str' => '3.600.000/1.000.000'} => '3.600.000/1.000.000',
      {'pol_public_liability_indemnity_limit_str' => '5.000.000/1.000.000'} => '5.000.000/1.000.000',
  ...
  def build_hash_sect_2()
    ...
    @target_values = {
      ...
      {'pol_bersani_str' => 'no'} => '//input[@name="/qol/application/beans/vo/VoBMAgevolata.intProvenienza" and @value="0"]',
      {'pol_coming_from_BM_str' => '-1'} => 'Classe 03',
      {'pol_coming_from_BM_str' => '1'} => 'Classe 03',
      {'pol_coming_from_BM_str' => '2'} => 'Classe 03',
      {'pol_coming_from_BM_str' => '3'} => 'Classe 03',
      {'pol_coming_from_BM_str' => '4'} => 'Classe 04',
      {'pol_coming_from_BM_str' => '5'} => 'Classe 05',
      {'pol_coming_from_BM_str' => '6'} => 'Classe 06',
      ...
      #      {'pol_instalment_str' => 'semestrale'} => 'Semestrale',
      {'pol_bersani_ref_vehicle_insured_with_company_str' => 'no'} => '//form/table[2]/tbody/tr[13]/td[2]/input[3]',
      {'pol_public_liability_indemnity_limit_str' => '3,000,000'} => '2.500.000/1.000.000',
      {'pol_public_liability_indemnity_limit_str' => '25,000,000'} => '2.500.000/1.000.000',
      {'pol_public_liability_indemnity_limit_str' => '18,000,000'} => '2.500.000/1.000.000',
      {'pol_public_liability_indemnity_limit_str' => '12,000,000'} => '2.500.000/1.000.000',
      {'pol_public_liability_indemnity_limit_str' => '6,000,000'} => '2.500.000/1.000.000',
      {'veh_vehicle_shelter_str' => 'box privato'} => 'Box privato',
      {'own_owner_sex_str' => 'M'} => '//input[@name="sessoContraente" and @value="M"]',
      {'own_owner_sex_str' => 'F'} => '//input[@name="sessoContraente" and @value="F"]',
      {'own_owner_sex_str' => 'C'} => '//input[@name="sessoContraente" and @value="M"]',
      ...
      {'pol_insurance_situation_str' => 'proveniente da altra compagnia'} => 'id_radio_bm',
      {'pol_insurance_situation_str' => '1a immatricolazione'} => '//input[@name="tipoPolizza" and @value="MN"]',  #/html/body/table[2]/tbody/tr/td[4]  precede sempre table/...
      #      {'pol_insurance_situation_str' => '1a polizza dopo l\'acquisto del veicolo usato'} => '//input[@name="tipoPolizza" and @value="AU"]',
      {'driv_civil_status_str' => 'Coniugato senza figli'} => 'Sposato/a',
      {'driv_civil_status_str' => 'Coniugato con figli'} => 'Sposato/a',
      ...
      {'veh_habitual_vehicle_use_str' => 'affari'} => 'Affari',
      {'veh_habitual_vehicle_use_str' => 'tempo libero'} => 'Tempo Libero',
      {'veh_vehicle_use_str' => 'privato'} => '//input[@name="CodUsoPra" and @value="PR"]',
      {'veh_vehicle_use_str' => 'promiscuo'} => '//input[@name="CodUsoPra" and @value="MX"]',
      {'veh_vehicle_type_str' => 'motociclo'} => 'Motociclo',
      {'pol_RCA_premium_id_str' => 'id elemento'} => 'premioRCADiv',
      {'pol_residence_province_str' => 'AG'} => 'AGRIGENTO',
      {'pol_residence_province_str' => 'AL'} => 'ALESSANDRIA',
