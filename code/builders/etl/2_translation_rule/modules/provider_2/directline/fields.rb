module Provider2Directline
  ...
  def build_hash_sect_1()
    ...
    @target_values = {
      ...
      {'pol_bersani_ref_vehicle_number_plate_str' => 'ab123cd'} => '//input[@id="targaConosciuta_" and @name="motorQuoteModel.targaConosciuta" and @value="TRUE"]',
      {'pol_bersani_ref_vehicle_number_plate_str' => 'no'} =>  '//input[@id="targaConosciuta_" and @name="motorQuoteModel.targaConosciuta" and @value="FALSE"]',
      {'pol_driver_less_than_26_yrs_str' => 'N'} => '0',
      {'pol_driver_less_than_26_yrs_str' => 'S'} => '1',
      {'veh_alarm_str' => 'nessuno'} => 'Nessuno',
      {'pol_bersani_str' => 'si'} => '//input[@name="/qol/application/beans/vo/VoBMAgevolata.intProvenienza" and @value="2"]',
      {'pol_bersani_str' => 'no'} => '//input[@name="/qol/application/beans/vo/VoBMAgevolata.intProvenienza" and @value="0"]',
      {'pol_coming_from_BM_str' => '0'} => 'Classe 01',
...
#      {'pol_family_car_num' => '1'} => 'numeroVeicoliFamiliariPosseduti_li_1',
      ...
      {'pol_public_liability_indemnity_limit_str' => '2.500.000/1.000.000'} => '2',
      {'pol_public_liability_indemnity_limit_str' => '2.500.000/ 500.000'} => '1',
  ...
  def build_hash_sect_2()
    ...
    @target_values = {
      ...
      {'driv_job_str' => 'agente o rappresent. di commercio'} => 'RAPPRESENTANTE',
