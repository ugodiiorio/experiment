module Provider2Linear
  ...
  def build_hash_sect_1()
    ...
    @rule_values = {
      ...
      'driv_driving_license_month_of_issue_str' => 'x= (DateTime::now - profilefield[:driv_driving_license_yrs_str].to_i.years ).strftime("%-1m"); y="index=" + x',
      ...
      'pol_birth_date_month_str' => 'x=(DateTime::now - profilefield[:pol_birth_date_str].to_i.years).strftime("%-1m"); y= "index=" + x',
...
#      'pol_matriculation_date_month_str' => 'profilefield[:pol_matriculation_date_str].length > 2 ? (profilefield[:pol_matriculation_date_str].length == 10 ? ( x= profilefield[:pol_matriculation_date_str].slice(3,2) ; ) : copy_field )  : x = (Chronic.parse(@rate_date) - profilefield[:pol_matriculation_date_str].to_i.years).strftime("%-1m"); y= "index=" + x',
       'pol_matriculation_date_month_str' => 'profilefield[:pol_matriculation_date_str].length > 2 ? (profilefield[:pol_matriculation_date_str].length == 10 ? ( x= "index=" + profilefield[:pol_matriculation_date_str].slice(3,2) ; ) : copy_field )  : x = "index = 1"',
