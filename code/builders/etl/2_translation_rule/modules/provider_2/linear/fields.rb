module Provider2Linear
  ...
  def build_hash_sect_1()
    ...
    @target_values = {
      ...
      {'pol_BM_assigned_str' => '0'} => '1 da più anni',
      ...
      {'pol_driver_less_than_26_yrs_str' => 'si'} => '21',
...
#      {'driv_driver_sex_str' => 'F'} => '//input[@name="sesso" and @value="2"]',
       ...
       {'own_owner_sex_str' => 'M'} => '//input[@id="sesso" and @value="1"]',
      {'own_owner_sex_str' => 'F'} => '//input[@id="sesso" and @value="2"]',
      {'driv_driver_sex_str' => 'M'} => '//input[@id="sesso" and @value="1"]',
      {'driv_driver_sex_str' => 'F'} => '//input[@id="sesso" and @value="2"]',
      ...
      {'veh_alarm_str' => 'nessuno'} => 'antifurto_auto',
      {'pol_leasing_str' => 'no'} => 'vincoli_auto',
      {'pol_public_liability_indemnity_limit_str' => '3,000,000'} => '€ 3.000.000,00 unico',
      {'pol_public_liability_indemnity_limit_str' => '25,000,000'} => '€ 5.000.000,00 unico',
      {'pol_public_liability_indemnity_limit_str' => '18,000,000'} => '€ 5.000.000,00 unico',
      {'pol_public_liability_indemnity_limit_str' => '12,000,000'} => '€ 5.000.000,00 unico',
      {'pol_public_liability_indemnity_limit_str' => '4,000,000'} => '€ 4.000.000,00 unico',

      {'pol_public_liability_indemnity_limit_str' => '1,600,000'} => 'regexpi:€\\s2\\.500\\.000 - 500\\.000',
      {'pol_public_liability_indemnity_limit_str' => '2,500,000'} => 'regexpi:€\\s2\\.500\\.000 - 500\\.000',
      {'pol_public_liability_indemnity_limit_str' => '5,000,000'} => '€ 5.000.000,00 unico',
...
#      {'pol_insurance_situation_str' => '1a polizza dopo l\'acquisto del veicolo usato'} => 'Deve essere assicurata per la prima volta',
  ...
  def build_hash_sect_2()
    ...
    @target_values = {
      ...
      {'pol_public_liability_indemnity_limit_str' => '18,000,000'} => '€ 5.000.000,00 unico',
      {'pol_public_liability_indemnity_limit_str' => '12,000,000'} => '€ 5.000.000,00 unico',
      {'pol_public_liability_indemnity_limit_str' => '6,000,000'} => '€ 5.000.000,00 unico',
