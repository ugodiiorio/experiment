module Provider2Quixa
  ...
  def build_hash_sect_2()
    ...
    @target_values = {
      ...
      {'pol_insurance_situation_str' => 'veicolo giÃ  assicurato con atr'} => 'Veicolo già assicurato con attestato di rischio',
      {'pol_insurance_situation_str' => '1a immatricolazione dopo lâ€™acquisto del veicolo'} => 'Prima Polizza dopo l\'acquisto di un veicolo',
      {'pol_leasing_str' => 'no'} => 'ctl00_ContentPlaceHolderMainArea_SimulatorContentPlaceHolderMainArea1_ucPersonalData_rbtLeasingNo',
      {'pol_nr_of_paid_claims_1_yr_str' => '0'} => '0',
      {'pol_nr_of_paid_claims_1_yr_str' => '1'} => '1',
