module Field_Mapping_Provider_1_Sect_1
  ...
  def build_hash_field_rule()
    ...
    @field_rule_values = {
      'driv_birth_place_str' => 'infield[:pol_residence_str].strip',
      'driv_birth_province_str' => 'infield[:pol_residence_province_str].strip',
      'driv_birth_state_str' => 'infield[:driv_citizenship_str].strip',
      'driv_citizenship_str' => 'infield[:driv_citizenship_str].strip',
      ...
      'pol_bersani_str' => 'infield[:pol_bersani_str].strip',
      'pol_birth_date_day_str' => '(DateTime::now - infield[:driv_driver_sex_str].slice(1 ,2).to_i.years-2.months).strftime("%F").slice(8,2)',
      'pol_birth_date_month_str' => '(DateTime::now - infield[:driv_driver_sex_str].slice(1 ,2).to_i.years-2.months).strftime("%F").slice(5,2)',
      'pol_birth_date_str' => '(DateTime::now - infield[:driv_driver_sex_str].slice(1, 2).to_i.years-2.months).strftime("%F")',
      'pol_birth_date_year_num' => '(DateTime::now - infield[:driv_driver_sex_str].slice(1 ,2).to_i.years-2.months).strftime("%F").slice(0,4).to_i',
      ...
      'pol_client_type_str' => 'infield[:driv_driver_sex_str].slice(0,1)',
      'pol_cohabiting_children_str' => '"si"',
      'pol_coming_from_BM_num' => 'bm=infield[:pol_BM_assigned_srt]; claimsyear=infield[:pol_nr_of_paid_claims_this_yr_str]; if claimsyear.to_i > 0;  bm= bm.to_i - 2  else  bm = bm.to_i + 1 end',
      ...
      'pol_driver_is_owner_str' => 'if infield[:own_owner_sex_str]=="C"; x= "si" else x= "no" end',
      'pol_driver_less_25_yrs_license_less_2_yrs_str' => 'infield[:pol_driver_less_than_26_yrs_str].strip',
      'pol_driver_less_than_26_yrs_str' => 'infield[:pol_driver_less_than_26_yrs_str].strip',
      ...
      'pol_driving_type_str' => 'if infield[:pol_driver_less_than_26_yrs_str]=="N" ; x= "esperta" else x= "libera" end',
      ...
      'pol_nr_of_goods_claims_1_yr_str' => '0',
      'pol_nr_of_goods_claims_2_yr_str' => '0',
      'pol_nr_of_goods_claims_3_yr_str' => '0',
      'pol_nr_of_goods_claims_4_yr_str' => '0',
      'pol_nr_of_goods_claims_5_yr_str' => '0',
      'pol_nr_of_goods_claims_this_yr_str' => nil,
      ...
      'pol_nr_of_persons_claims_1_yr_str' => '0',
      'pol_nr_of_persons_claims_2_yr_str' => '0',
      'pol_nr_of_persons_claims_3_yr_str' => '0',
      'pol_nr_of_persons_claims_4_yr_str' => '0',
      'pol_nr_of_persons_claims_5_yr_str' => '0',
      'pol_nr_of_persons_claims_this_yr_str' => '0',
      ...
      'pol_subscriber_is_driver_str' => '"si"',
      'pol_subscriber_is_holder_str' => '"si"',
      'pol_subscriber_is_owner_str' => 'if infield[:own_owner_sex_str]=="C"; x= "si" else x= "no" end',
      ...
      'veh_gprs_str' => '"no"',
      'veh_habitual_vehicle_use_str' => 'infield[:veh_habitual_vehicle_use_str].strip',
