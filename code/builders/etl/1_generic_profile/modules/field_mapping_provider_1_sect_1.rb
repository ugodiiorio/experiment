module FieldMappingProvider1Sect1
  ...
  def build_hash_field_rule()
    ...
    @field_rule_values = {
      ...
      'veh_set_up_previous_vehicle_str' =>  'a=infield[:veh_set_up_previous_vehicle_str].strip; b= a.gsub(/à/,"a" );c= b.gsub(/è/,"e" );d= c.gsub(/é/,"e" );e= d.gsub(/ì/,"i" );f= e.gsub(/ò/,"o" );g= f.gsub(/ù/,"u" ); h= g.gsub(/°/,"a" ); f= h.gsub(/ª/,"a" );',
      ...
      'pol_assistance_code_ str' => nil,
      'pol_assistance_on_off_ str' => nil,
      'pol_athmospheric_events_code_ str' => nil,
      'pol_athmospheric_events_on_off_ str' => nil,
      'pol_blukasko_code_ str' => nil,
      'pol_blukasko_on_off_ str' => nil,
      'pol_claims_total_number_malus_str' => nil,
      'pol_contingency_protection_code_ str' => nil,
      'pol_contingency_protection_on_off_ str' => nil,
      'pol_driver_accident_coverage_code_ str' => nil,
      'pol_driver_accident_coverage_on_off_ str' => nil,
      'pol_driver_accident_indemnity_limit_str' => nil,
      'pol_driving_licence_withdrawal_guarantee_code_ str' => nil,
      'pol_driving_licence_withdrawal_guarantee_on_off_ str' => nil,
      'pol_driving_license_withdrawal_indemnity_limit_str' => nil,
      'pol_easy_driver_code_ str' => nil,
      'pol_easy_driver_on_off_ str' => nil,
      'pol_glasses_code_ str' => nil,
      'pol_glasses_minimum_uncovered_str' => nil,
      'pol_glasses_on_off_ str' => nil,
      'pol_kasko_code_ str' => nil,
      'pol_kasko_minimum_uncoverage_str' => nil,
      'pol_kasko_on_off_ str' => nil,
      'pol_legal_assistance_code_ str' => nil,
      'pol_legal_assistance_on_off_ str' => nil,
      'pol_motorcycle_driving_ability_str' => nil,
      'pol_natural_events_act_of_vandalism_code_ str' => nil,
      'pol_natural_events_act_of_vandalism_minimum_uncoverage_str' => nil,
      'pol_natural_events_act_of_vandalism_on_off_ str' => nil,
      'pol_natural_events_code_ str' => nil,
      'pol_natural_events_on_off_ str' => nil,
      'pol_pejus_cu_str' => nil, ,
      'pol_public_liability_type_str' => nil,
      'pol_RCA_on_off_str' => nil,
      'pol_road_assistance_code_ str' => nil,
      'pol_road_assistance_indemnity_limit_str' => nil,
      'pol_road_assistance_on_off_ str' => nil,
      'pol_road_assistance_type_str' => nil,
      'pol_social_political_and_natural_events_code_ str' => nil,
      'pol_social_political_and_natural_events_on_off_ str' => nil,
      'pol_social_political_events_code_ str' => nil,
      'pol_social_political_events_on_off_ str' => nil,
      'pol_supplementary_coverage_code_ str' => nil,
      'pol_supplementary_coverage_on_off_ str' => nil,
      'pol_theft_fire_coverage_code_str' => nil,
      'pol_theft_fire_coverage_on_off_ str' => nil,
