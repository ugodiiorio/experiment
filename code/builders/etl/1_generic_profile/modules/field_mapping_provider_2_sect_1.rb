module FieldMappingProvider2Sect1
  ...
  def build_hash_field_rule()
    ...
    @field_rule_values = {
      ...
      'driv_driver_sex_str'  => 'infield[:driv_driver_sex].strip.upcase' ,
      'driv_driving_experience_str'  => nil ,
      'driv_driving_license_month_of_issue_str'  => '(DateTime::now - infield[:driv_driving_license_yrs_str].to_i.years).strftime("%m")' ,
      'driv_driving_license_points_str'  => '"20"' ,
      'driv_driving_license_type_str'  => '"B"' ,
      'driv_driving_license_year_of_issue_str'  => '(DateTime::now - infield[:driv_driving_license_yrs_str].to_i.years).strftime("%Y")' ,
      ...
      'pol_birth_date_day_str'  => '(DateTime::now - infield[:driv_driver_sex_str].to_i.years-2.months).strftime("%d")' ,
      'pol_birth_date_month_str'  => '(DateTime::now - infield[:driv_driver_sex_str].to_i.years-2.months).strftime("%m")' ,
      'pol_birth_date_str'  => '(DateTime::now - infield[:driv_driver_sex_str].to_i.years-2.months).strftime("%F")' ,
      'pol_birth_date_year_num'  => '(DateTime::now - infield[:driv_driver_sex_str].to_i.years-2.months).strftime("%Y")' ,
      ...
      'pol_leasing_str'  => '"no"' ,
      'pol_matriculation_date_day_str'  => 'ageveh= infield[:pol_matriculation_date_str].to_i; sitass=infield[:pol_insurance_situation_str];  if sitass=~/1a*\\s*[(A-Za-z0-9)*(\\s)*]*/ ; (DateTime::now - 2.months).strftime("%d")  else (DateTime::now - ageveh.years).strftime("%d") end' ,
      'pol_matriculation_date_month_str'  => 'ageveh= infield[:pol_matriculation_date_str].to_i; sitass=infield[:pol_insurance_situation_str];  if sitass=~/1a*\\s*[(A-Za-z0-9)*(\\s)*]*/ ; (DateTime::now - 2.months).strftime("%m")  else (DateTime::now - ageveh.years).strftime("%m") end' ,
      'pol_matriculation_date_str'  => 'ageveh= infield[:pol_matriculation_date_str].to_i; sitass=infield[:pol_insurance_situation_str];  if sitass=~/1a*\\s*[(A-Za-z0-9)*(\\s)*]*/ ; (DateTime::now - 2.months).strftime("%F")  else (DateTime::now - ageveh.years).strftime("%F") end' ,
      'pol_matriculation_date_year_num'  => 'ageveh= infield[:pol_matriculation_date_str].to_i; sitass=infield[:pol_insurance_situation_str];  if sitass=~/1a*\\s*[(A-Za-z0-9)*(\\s)*]*/ ; (DateTime::now - 2.months).strftime("%Y")  else (DateTime::now - ageveh.years).strftime("%Y") end' ,
      ...
      'veh_purchase_date_day_str'  => 'ageveh= infield[:pol_matriculation_date_str].to_i; sitass=infield[:pol_insurance_situation_str];  if sitass=~/1a*\\s*[(A-Za-z0-9)*(\\s)*]*/ ; (DateTime::now - 2.months).strftime("%d")  else (DateTime::now - ageveh.years).strftime("%d")) end' ,
      'veh_purchase_date_month_str'  => 'ageveh= infield[:pol_matriculation_date_str].to_i; sitass=infield[:pol_insurance_situation_str];  if sitass=~/1a*\\s*[(A-Za-z0-9)*(\\s)*]*/ ; (DateTime::now - 2.months).strftime("%m")  else (DateTime::now - ageveh.years).strftime("%m")) end' ,
      'veh_purchase_date_str'  => 'ageveh= infield[:pol_matriculation_date_str].to_i; sitass=infield[:pol_insurance_situation_str];  if sitass=~/1a*\\s*[(A-Za-z0-9)*(\\s)*]*/ ; (DateTime::now - 2.months).strftime("%F")  else (DateTime::now - ageveh.years).strftime("%F")) end' ,
      'veh_purchase_date_year_num'  => 'ageveh= infield[:pol_matriculation_date_str].to_i; sitass=infield[:pol_insurance_situation_str];  if sitass=~/1a*\\s*[(A-Za-z0-9)*(\\s)*]*/ ; (DateTime::now - 2.months).strftime("%Y")  else (DateTime::now - ageveh.years).strftime("%Y")) end' ,
