...
pol_act_of_vandalism_on_off_ str,     VARCHAR(128)
...
pol_assistance_on_off_ str,     VARCHAR(128)
...
pol_athmospheric_events_on_off_ str,     VARCHAR(128)
...
pol_blukasko_on_off_ str,     VARCHAR(128)
...
pol_contingency_protection_on_off_ str,     VARCHAR(128)
...
pol_driver_accident_coverage_on_off_ str,     VARCHAR(128)
...
pol_driving_licence_withdrawal_guarantee_on_off_ str,     VARCHAR(128)
...
pol_easy_driver_on_off_ str,     VARCHAR(128)
...
pol_glasses_on_off_ str,     VARCHAR(128)
...
pol_natural_events_act_of_vandalism_on_off_ str,     VARCHAR(128)
...
pol_natural_events_on_off_ str,     VARCHAR(128)
...
pol_road_assistance_on_off_ str,     VARCHAR(128)
...
pol_social_political_and_natural_events_on_off_ str,     VARCHAR(128)
...
pol_social_political_events_on_off_ str,     VARCHAR(128)
...
pol_supplementary_coverage_on_off_ str,     VARCHAR(128)
...
pol_theft_fire_coverage_on_off_ str,     VARCHAR(128)
