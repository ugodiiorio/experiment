...
class BuildDriverSchema
  ...
  def initialize(db_host, db_user, db_pwd, db_default_driver)
    ...
    mysql.query("CREATE TABLE " + @db_default_driver + ".insurance_profiles (
        ...
        pol_coming_from_BM_str     VARCHAR(128),
        ...
        pol_first_claim_year_str     VARCHAR(128),
        ...
        veh_set_up_previous_vehicle_str     VARCHAR(512),
        veh_set_up_str     VARCHAR(1024),
