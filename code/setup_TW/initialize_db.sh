...
mysql -u root -pkub01d --database=kte_driver -e "delete from companies; load data local infile \"/home/notroot/git/KTE/code/builders/etl/1_generic_profile/csv/companies.csv\" into table companies fields terminated by \"#\" escaped by \"\";"
